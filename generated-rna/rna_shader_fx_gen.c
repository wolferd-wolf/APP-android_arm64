...
void ShaderFxRim_blur_set(PointerRNA *ptr, const int values[2])
{
    ...
    { BLI_STATIC_ASSERT((TYPEOF_MAX(*data->blur) >= 32767) && (TYPEOF_MIN(*data->blur) <= 0), "invalid limits"); }
}
...
void ShaderFxSwirl_radius_set(PointerRNA *ptr, int value)
{
    ...
    { BLI_STATIC_ASSERT((TYPEOF_MAX(data->radius) >= 32767) && (TYPEOF_MIN(data->radius) <= 0), "invalid limits"); }
}
...
FloatPropertyRNA rna_ShaderFxBlur_size = {
	...
	NULL, NULL, ShaderFxBlur_size_get, ShaderFxBlur_size_set, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, FLT_MAX, 0.0f, FLT_MAX, 10.0f, 3, 0.0f, rna_ShaderFxBlur_size_default
};
...
FloatPropertyRNA rna_ShaderFxBlur_rotation = {
	...
	ShaderFxBlur_rotation_get, ShaderFxBlur_rotation_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, -FLT_MAX, FLT_MAX, -FLT_MAX, FLT_MAX, 10.0f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_ShaderFxColorize_factor = {
	...
	ShaderFxColorize_factor_get, ShaderFxColorize_factor_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 1.0f, 0.0f, 1.0f, 10.0f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_ShaderFxColorize_low_color = {
	...
	NULL, NULL, ShaderFxColorize_low_color_get, ShaderFxColorize_low_color_set, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 1.0f, 0.0f, 1.0f, 10.0f, 3, 0.0f, rna_ShaderFxColorize_low_color_default
};
...
FloatPropertyRNA rna_ShaderFxColorize_high_color = {
	...
	NULL, NULL, ShaderFxColorize_high_color_get, ShaderFxColorize_high_color_set, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 1.0f, 0.0f, 1.0f, 10.0f, 3, 0.0f, rna_ShaderFxColorize_high_color_default
};
...
FloatPropertyRNA rna_ShaderFxWave_amplitude = {
	...
	ShaderFxWave_amplitude_get, ShaderFxWave_amplitude_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, FLT_MAX, 0.0f, FLT_MAX, 10.0f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_ShaderFxWave_period = {
	...
	ShaderFxWave_period_get, ShaderFxWave_period_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, FLT_MAX, 0.0f, FLT_MAX, 10.0f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_ShaderFxWave_phase = {
	...
	ShaderFxWave_phase_get, ShaderFxWave_phase_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, -FLT_MAX, FLT_MAX, -FLT_MAX, FLT_MAX, 10.0f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_ShaderFxRim_rim_color = {
	...
	NULL, NULL, ShaderFxRim_rim_color_get, ShaderFxRim_rim_color_set, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 1.0f, 0.0f, 1.0f, 10.0f, 3, 0.0f, rna_ShaderFxRim_rim_color_default
};
...
FloatPropertyRNA rna_ShaderFxRim_mask_color = {
	...
	NULL, NULL, ShaderFxRim_mask_color_get, ShaderFxRim_mask_color_set, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 1.0f, 0.0f, 1.0f, 10.0f, 3, 0.0f, rna_ShaderFxRim_mask_color_default
};
...
FloatPropertyRNA rna_ShaderFxShadow_scale = {
	...
	NULL, NULL, ShaderFxShadow_scale_get, ShaderFxShadow_scale_set, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, -FLT_MAX, FLT_MAX, -FLT_MAX, FLT_MAX, 10.0f, 3, 0.0f, rna_ShaderFxShadow_scale_default
};
...
FloatPropertyRNA rna_ShaderFxShadow_shadow_color = {
	...
	NULL, NULL, ShaderFxShadow_shadow_color_get, ShaderFxShadow_shadow_color_set, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 1.0f, 0.0f, 1.0f, 10.0f, 3, 0.0f, rna_ShaderFxShadow_shadow_color_default
};
...
FloatPropertyRNA rna_ShaderFxShadow_amplitude = {
	...
	ShaderFxShadow_amplitude_get, ShaderFxShadow_amplitude_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, FLT_MAX, 0.0f, FLT_MAX, 10.0f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_ShaderFxShadow_period = {
	...
	ShaderFxShadow_period_get, ShaderFxShadow_period_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, FLT_MAX, 0.0f, FLT_MAX, 10.0f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_ShaderFxShadow_phase = {
	...
	ShaderFxShadow_phase_get, ShaderFxShadow_phase_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, -FLT_MAX, FLT_MAX, -FLT_MAX, FLT_MAX, 10.0f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_ShaderFxShadow_rotation = {
	...
	ShaderFxShadow_rotation_get, ShaderFxShadow_rotation_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, -6.2831854820f, 6.2831854820f, -6.2831854820f, 6.2831854820f, 5.0f, 2, 0.0f, NULL
};
...
FloatPropertyRNA rna_ShaderFxGlow_glow_color = {
	...
	NULL, NULL, ShaderFxGlow_glow_color_get, ShaderFxGlow_glow_color_set, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 1.0f, 0.0f, 1.0f, 10.0f, 3, 0.0f, rna_ShaderFxGlow_glow_color_default
};
...
FloatPropertyRNA rna_ShaderFxGlow_opacity = {
	...
	ShaderFxGlow_opacity_get, ShaderFxGlow_opacity_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 1.0f, 0.0f, 1.0f, 10.0f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_ShaderFxGlow_select_color = {
	...
	NULL, NULL, ShaderFxGlow_select_color_get, ShaderFxGlow_select_color_set, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 1.0f, 0.0f, 1.0f, 10.0f, 3, 0.0f, rna_ShaderFxGlow_select_color_default
};
...
FloatPropertyRNA rna_ShaderFxGlow_threshold = {
	...
	ShaderFxGlow_threshold_get, ShaderFxGlow_threshold_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 1.0f, 0.0f, 1.0f, 0.1000000015f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_ShaderFxGlow_size = {
	...
	NULL, NULL, ShaderFxGlow_size_get, ShaderFxGlow_size_set, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, FLT_MAX, 0.0f, FLT_MAX, 10.0f, 3, 0.0f, rna_ShaderFxGlow_size_default
};
...
FloatPropertyRNA rna_ShaderFxGlow_rotation = {
	...
	ShaderFxGlow_rotation_get, ShaderFxGlow_rotation_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, -FLT_MAX, FLT_MAX, -FLT_MAX, FLT_MAX, 10.0f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_ShaderFxSwirl_angle = {
	...
	ShaderFxSwirl_angle_get, ShaderFxSwirl_angle_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, -31.4159259796f, 31.4159259796f, -31.4159259796f, 31.4159259796f, 5.0f, 2, 0.0f, NULL
};

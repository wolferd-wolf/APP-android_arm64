...
void Brush_dash_samples_set(PointerRNA *ptr, int value)
{
    ...
    { BLI_STATIC_ASSERT((TYPEOF_MAX(data->dash_samples) >= 10000) && (TYPEOF_MIN(data->dash_samples) <= 1), "invalid limits"); }
}
...
void Brush_surface_smooth_iterations_set(PointerRNA *ptr, int value)
{
    ...
    { BLI_STATIC_ASSERT((TYPEOF_MAX(data->surface_smooth_iterations) >= 10) && (TYPEOF_MIN(data->surface_smooth_iterations) <= 1), "invalid limits"); }
}
...
void Brush_pose_smooth_iterations_set(PointerRNA *ptr, int value)
{
    ...
    { BLI_STATIC_ASSERT((TYPEOF_MAX(data->pose_smooth_iterations) >= 100) && (TYPEOF_MIN(data->pose_smooth_iterations) <= 0), "invalid limits"); }
}
...
void Brush_pose_ik_segments_set(PointerRNA *ptr, int value)
{
    ...
    { BLI_STATIC_ASSERT((TYPEOF_MAX(data->pose_ik_segments) >= 20) && (TYPEOF_MIN(data->pose_ik_segments) <= 1), "invalid limits"); }
}
...
void Brush_automasking_boundary_edges_propagation_steps_set(PointerRNA *ptr, int value)
{
    ...
    { BLI_STATIC_ASSERT((TYPEOF_MAX(data->automasking_boundary_edges_propagation_steps) >= 20) && (TYPEOF_MIN(data->automasking_boundary_edges_propagation_steps) <= 1), "invalid limits"); }
}
...
void Brush_automasking_cavity_blur_steps_set(PointerRNA *ptr, int value)
{
    ...
    { BLI_STATIC_ASSERT((TYPEOF_MAX(data->automasking_cavity_blur_steps) >= 25) && (TYPEOF_MIN(data->automasking_cavity_blur_steps) <= 0), "invalid limits"); }
}
...
{
    Brush *data = (Brush *)(ptr->data);
    return (((data->flag) & 2147483648LL) != 0);
}

void Brush_use_curve_set(PointerRNA *ptr, bool value)
{
    Brush *data = (Brush *)(ptr->data);
    if (value) { data->flag |= 2147483648LL; }
    else { data->flag &= ~2147483648LL; }
}
...
void BrushGpencilSettings_pen_smooth_steps_set(PointerRNA *ptr, int value)
{
    ...
    { BLI_STATIC_ASSERT((TYPEOF_MAX(data->draw_smoothlvl) >= 100) && (TYPEOF_MIN(data->draw_smoothlvl) <= 0), "invalid limits"); }
}
...
void BrushGpencilSettings_dilate_set(PointerRNA *ptr, int value)
{
    ...
    { BLI_STATIC_ASSERT((TYPEOF_MAX(data->dilate_pixels) >= 40) && (TYPEOF_MIN(data->dilate_pixels) <= -40), "invalid limits"); }
}
...
void BrushGpencilSettings_material_alt_set(PointerRNA *ptr, PointerRNA value, struct ReportList *reports)
{
    BrushGpencilSettings *data = (BrushGpencilSettings *)(ptr->data);
    ID *id = ptr->owner_id;
    if (id == value.data) {
...
void BrushCurvesSculptSettings_add_amount_set(PointerRNA *ptr, int value)
{
    ...
    { BLI_STATIC_ASSERT((TYPEOF_MAX(data->add_amount) >= 2147483647) && (TYPEOF_MIN(data->add_amount) <= 1), "invalid limits"); }
}
...
void BrushCurvesSculptSettings_points_per_curve_set(PointerRNA *ptr, int value)
{
    ...
    { BLI_STATIC_ASSERT((TYPEOF_MAX(data->points_per_curve) >= 2147483647) && (TYPEOF_MIN(data->points_per_curve) <= 2), "invalid limits"); }
}
...
void BrushCurvesSculptSettings_density_add_attempts_set(PointerRNA *ptr, int value)
{
    ...
    { BLI_STATIC_ASSERT((TYPEOF_MAX(data->density_add_attempts) >= 2147483647) && (TYPEOF_MIN(data->density_add_attempts) <= 0), "invalid limits"); }
}
...
EnumPropertyRNA rna_Brush_gpencil_weight_tool = {
	...
	Brush_gpencil_weight_tool_get, Brush_gpencil_weight_tool_set, NULL, NULL, NULL, rna_enum_brush_gpencil_weight_types_items, 4, 0
};
...
EnumPropertyRNA rna_Brush_curves_sculpt_tool = {
	...
	Brush_curves_sculpt_tool_get, Brush_curves_sculpt_tool_set, NULL, NULL, NULL, rna_enum_brush_curves_sculpt_tool_items, 13, 0
};
...
FloatPropertyRNA rna_Brush_unprojected_radius = {
	...
	rna_Brush_size_update, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	Brush_unprojected_radius_get, Brush_unprojected_radius_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0010000000f, 1.0f, 0.0010000000f, FLT_MAX, 1.0f, -1, 0.0f, NULL
};
...
FloatPropertyRNA rna_Brush_jitter = {
	...
	Brush_jitter_get, Brush_jitter_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 2.0f, 0.0f, 1000.0f, 0.1000000015f, 4, 0.0f, NULL
};
...
FloatPropertyRNA rna_Brush_smooth_stroke_factor = {
	...
	Brush_smooth_stroke_factor_get, Brush_smooth_stroke_factor_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.5000000000f, 0.9900000095f, 0.5000000000f, 0.9900000095f, 10.0f, 3, 0.8999999762f, NULL
};
...
FloatPropertyRNA rna_Brush_rate = {
	...
	Brush_rate_get, Brush_rate_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0099999998f, 1.0f, 0.0001000000f, 10000.0f, 1.0f, 3, 0.1000000015f, NULL
};
...
FloatPropertyRNA rna_Brush_color = {
	...
	NULL, NULL, Brush_color_get, Brush_color_set, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 1.0f, 0.0f, 1.0f, 10.0f, 3, 0.0f, rna_Brush_color_default
};
...
FloatPropertyRNA rna_Brush_secondary_color = {
	...
	NULL, NULL, Brush_secondary_color_get, Brush_secondary_color_set, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 1.0f, 0.0f, 1.0f, 10.0f, 3, 0.0f, rna_Brush_secondary_color_default
};
...
FloatPropertyRNA rna_Brush_weight = {
	...
	Brush_weight_get, Brush_weight_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 1.0f, 0.0f, 1.0f, 0.0010000000f, 3, 1.0f, NULL
};
...
FloatPropertyRNA rna_Brush_strength = {
	...
	Brush_strength_get, Brush_strength_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 1.0f, 0.0f, 10.0f, 0.0010000000f, 3, 1.0f, NULL
};
...
FloatPropertyRNA rna_Brush_flow = {
	...
	Brush_flow_get, Brush_flow_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 1.0f, 0.0f, 1.0f, 0.0010000000f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_Brush_wet_mix = {
	...
	Brush_wet_mix_get, Brush_wet_mix_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 1.0f, 0.0f, 1.0f, 0.0010000000f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_Brush_wet_persistence = {
	...
	Brush_wet_persistence_get, Brush_wet_persistence_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 1.0f, 0.0f, 1.0f, 0.0010000000f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_Brush_density = {
	...
	Brush_density_get, Brush_density_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 1.0f, 0.0f, 1.0f, 0.0010000000f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_Brush_tip_scale_x = {
	...
	Brush_tip_scale_x_get, Brush_tip_scale_x_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 1.0f, 0.0f, 1.0f, 0.0010000000f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_Brush_dash_ratio = {
	...
	Brush_dash_ratio_get, Brush_dash_ratio_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 1.0f, 0.0f, 1.0f, 0.0010000000f, 3, 1.0f, NULL
};
...
FloatPropertyRNA rna_Brush_plane_offset = {
	...
	Brush_plane_offset_get, Brush_plane_offset_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, -0.5000000000f, 0.5000000000f, -2.0f, 2.0f, 0.0010000000f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_Brush_plane_trim = {
	...
	Brush_plane_trim_get, Brush_plane_trim_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 1.0f, 0.0f, 1.0f, 10.0f, 3, 0.5000000000f, NULL
};
...
FloatPropertyRNA rna_Brush_height = {
	...
	Brush_height_get, Brush_height_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 0.2000000030f, 0.0f, 1.0f, 1.0f, 3, 0.5000000000f, NULL
};
...
FloatPropertyRNA rna_Brush_texture_sample_bias = {
	...
	Brush_texture_sample_bias_get, Brush_texture_sample_bias_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, -1.0f, 1.0f, -1.0f, 1.0f, 10.0f, 3, 0.0f, NULL
};
...
BoolPropertyRNA rna_Brush_use_color_as_displacement = {
	...
	rna_Brush_update, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	Brush_use_color_as_displacement_get, Brush_use_color_as_displacement_set, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};
...
FloatPropertyRNA rna_Brush_normal_weight = {
	...
	Brush_normal_weight_get, Brush_normal_weight_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 1.0f, 0.0f, 1.0f, 10.0f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_Brush_elastic_deform_volume_preservation = {
	...
	Brush_elastic_deform_volume_preservation_get, Brush_elastic_deform_volume_preservation_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 0.8999999762f, 0.0f, 0.8999999762f, 0.0099999998f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_Brush_rake_factor = {
	...
	Brush_rake_factor_get, Brush_rake_factor_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 1.0f, 0.0f, 10.0f, 0.0010000000f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_Brush_crease_pinch_factor = {
	...
	Brush_crease_pinch_factor_get, Brush_crease_pinch_factor_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 1.0f, 0.0f, 1.0f, 10.0f, 3, 0.5000000000f, NULL
};
...
FloatPropertyRNA rna_Brush_pose_offset = {
	...
	Brush_pose_offset_get, Brush_pose_offset_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 2.0f, 0.0f, 2.0f, 10.0f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_Brush_disconnected_distance_max = {
	...
	Brush_disconnected_distance_max_get, Brush_disconnected_distance_max_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 10.0f, 0.0f, 10.0f, 10.0f, 3, 0.1000000015f, NULL
};
...
FloatPropertyRNA rna_Brush_boundary_offset = {
	...
	Brush_boundary_offset_get, Brush_boundary_offset_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 30.0f, 0.0f, 30.0f, 10.0f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_Brush_surface_smooth_shape_preservation = {
	...
	Brush_surface_smooth_shape_preservation_get, Brush_surface_smooth_shape_preservation_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 1.0f, 0.0f, 1.0f, 10.0f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_Brush_surface_smooth_current_vertex = {
	...
	Brush_surface_smooth_current_vertex_get, Brush_surface_smooth_current_vertex_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 1.0f, 0.0f, 1.0f, 10.0f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_Brush_multiplane_scrape_angle = {
	...
	Brush_multiplane_scrape_angle_get, Brush_multiplane_scrape_angle_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 160.0f, 0.0f, 160.0f, 10.0f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_Brush_tip_roundness = {
	...
	Brush_tip_roundness_get, Brush_tip_roundness_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 1.0f, 0.0f, 1.0f, 10.0f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_Brush_cloth_mass = {
	...
	Brush_cloth_mass_get, Brush_cloth_mass_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0099999998f, 2.0f, 0.0099999998f, 2.0f, 10.0f, 3, 1.0f, NULL
};
...
FloatPropertyRNA rna_Brush_cloth_damping = {
	...
	Brush_cloth_damping_get, Brush_cloth_damping_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0099999998f, 1.0f, 0.0099999998f, 1.0f, 10.0f, 3, 0.0099999998f, NULL
};
...
FloatPropertyRNA rna_Brush_cloth_sim_limit = {
	...
	Brush_cloth_sim_limit_get, Brush_cloth_sim_limit_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.1000000015f, 10.0f, 0.1000000015f, 10.0f, 10.0f, 3, 2.5000000000f, NULL
};
...
FloatPropertyRNA rna_Brush_cloth_sim_falloff = {
	...
	Brush_cloth_sim_falloff_get, Brush_cloth_sim_falloff_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 1.0f, 0.0f, 1.0f, 10.0f, 3, 0.7500000000f, NULL
};
...
FloatPropertyRNA rna_Brush_cloth_constraint_softbody_strength = {
	...
	Brush_cloth_constraint_softbody_strength_get, Brush_cloth_constraint_softbody_strength_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 1.0f, 0.0f, 1.0f, 10.0f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_Brush_hardness = {
	...
	Brush_hardness_get, Brush_hardness_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 1.0f, 0.0f, 1.0f, 10.0f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_Brush_auto_smooth_factor = {
	...
	Brush_auto_smooth_factor_get, Brush_auto_smooth_factor_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 1.0f, 0.0f, 1.0f, 0.0010000000f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_Brush_topology_rake_factor = {
	...
	Brush_topology_rake_factor_get, Brush_topology_rake_factor_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 1.0f, 0.0f, 1.0f, 0.0010000000f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_Brush_tilt_strength_factor = {
	...
	Brush_tilt_strength_factor_get, Brush_tilt_strength_factor_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 1.0f, 0.0f, 1.0f, 0.0010000000f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_Brush_normal_radius_factor = {
	...
	Brush_normal_radius_factor_get, Brush_normal_radius_factor_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 2.0f, 0.0f, 2.0f, 0.0010000000f, 3, 0.5000000000f, NULL
};
...
FloatPropertyRNA rna_Brush_area_radius_factor = {
	...
	Brush_area_radius_factor_get, Brush_area_radius_factor_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 2.0f, 0.0f, 2.0f, 0.0010000000f, 3, 0.5000000000f, NULL
};
...
FloatPropertyRNA rna_Brush_wet_paint_radius_factor = {
	...
	Brush_wet_paint_radius_factor_get, Brush_wet_paint_radius_factor_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 2.0f, 0.0f, 2.0f, 0.0010000000f, 3, 0.5000000000f, NULL
};
...
FloatPropertyRNA rna_Brush_stencil_pos = {
	...
	NULL, NULL, Brush_stencil_pos_get, Brush_stencil_pos_set, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, -10000.0f, 10000.0f, -FLT_MAX, FLT_MAX, 10.0f, 3, 0.0f, rna_Brush_stencil_pos_default
};
...
FloatPropertyRNA rna_Brush_stencil_dimension = {
	...
	NULL, NULL, Brush_stencil_dimension_get, Brush_stencil_dimension_set, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, -10000.0f, 10000.0f, -FLT_MAX, FLT_MAX, 10.0f, 3, 0.0f, rna_Brush_stencil_dimension_default
};
...
FloatPropertyRNA rna_Brush_mask_stencil_pos = {
	...
	NULL, NULL, Brush_mask_stencil_pos_get, Brush_mask_stencil_pos_set, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, -10000.0f, 10000.0f, -FLT_MAX, FLT_MAX, 10.0f, 3, 0.0f, rna_Brush_mask_stencil_pos_default
};
...
FloatPropertyRNA rna_Brush_mask_stencil_dimension = {
	...
	NULL, NULL, Brush_mask_stencil_dimension_get, Brush_mask_stencil_dimension_set, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, -10000.0f, 10000.0f, -FLT_MAX, FLT_MAX, 10.0f, 3, 0.0f, rna_Brush_mask_stencil_dimension_default
};
...
FloatPropertyRNA rna_Brush_sharp_threshold = {
	...
	Brush_sharp_threshold_get, Brush_sharp_threshold_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 1.0f, 0.0f, 100.0f, 1.0f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_Brush_fill_threshold = {
	...
	Brush_fill_threshold_get, Brush_fill_threshold_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 1.0f, 0.0f, 100.0f, 1.0f, 3, 0.2000000030f, NULL
};
...
FloatPropertyRNA rna_Brush_falloff_angle = {
	...
	Brush_falloff_angle_get, Brush_falloff_angle_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 1.5707963705f, 0.0f, 1.5707963705f, 10.0f, 3, 0.0f, NULL
};
...
BoolPropertyRNA rna_Brush_use_automasking_cavity = {
	...
	rna_Brush_update, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	Brush_use_automasking_cavity_get, Brush_use_automasking_cavity_set, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};
...
BoolPropertyRNA rna_Brush_use_automasking_cavity_inverted = {
	...
	rna_Brush_update, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	Brush_use_automasking_cavity_inverted_get, Brush_use_automasking_cavity_inverted_set, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};
...
BoolPropertyRNA rna_Brush_use_automasking_custom_cavity_curve = {
	...
	rna_Brush_update, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	Brush_use_automasking_custom_cavity_curve_get, Brush_use_automasking_custom_cavity_curve_set, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};
...
FloatPropertyRNA rna_Brush_automasking_cavity_factor = {
	...
	PROP_FLOAT, PROP_FACTOR | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Brush_update, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	offsetof(Brush, automasking_cavity_factor), 5, NULL},
	Brush_automasking_cavity_factor_get, Brush_automasking_cavity_factor_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 1.0f, 0.0f, 5.0f, 0.1000000015f, 3, 1.0f, NULL
};
...
IntPropertyRNA rna_Brush_automasking_cavity_blur_steps = {
	...
	PROP_INT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Brush_update, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	offsetof(Brush, automasking_cavity_blur_steps), 0, NULL},
	Brush_automasking_cavity_blur_steps_get, Brush_automasking_cavity_blur_steps_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL,
	0, 0, 10, 0, 25, 1, 0, NULL
};
...
PointerPropertyRNA rna_Brush_automasking_cavity_curve = {
	...
	rna_Brush_update, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	Brush_automasking_cavity_curve_get, NULL, NULL, NULL,&RNA_CurveMapping
};
...
BoolPropertyRNA rna_Brush_use_automasking_start_normal = {
	...
	rna_Brush_update, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	Brush_use_automasking_start_normal_get, Brush_use_automasking_start_normal_set, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};
...
BoolPropertyRNA rna_Brush_use_automasking_view_normal = {
	...
	rna_Brush_update, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	Brush_use_automasking_view_normal_get, Brush_use_automasking_view_normal_set, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};
...
BoolPropertyRNA rna_Brush_use_automasking_view_occlusion = {
	...
	rna_Brush_update, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	Brush_use_automasking_view_occlusion_get, Brush_use_automasking_view_occlusion_set, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};
...
BoolPropertyRNA rna_Brush_use_paint_sculpt_curves = {
	...
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	Brush_use_paint_sculpt_curves_get, Brush_use_paint_sculpt_curves_set, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};
...
FloatPropertyRNA rna_Brush_cursor_color_add = {
	...
	NULL, NULL, Brush_cursor_color_add_get, Brush_cursor_color_add_set, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 1.0f, 0.0f, FLT_MAX, 10.0f, 3, 0.0f, rna_Brush_cursor_color_add_default
};
...
FloatPropertyRNA rna_Brush_cursor_color_subtract = {
	...
	NULL, NULL, Brush_cursor_color_subtract_get, Brush_cursor_color_subtract_set, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 1.0f, 0.0f, FLT_MAX, 10.0f, 3, 0.0f, rna_Brush_cursor_color_subtract_default
};
...
FloatPropertyRNA rna_Brush_clone_alpha = {
	...
	Brush_clone_alpha_get, Brush_clone_alpha_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 1.0f, 0.0f, 1.0f, 10.0f, 3, 0.5000000000f, NULL
};
...
FloatPropertyRNA rna_Brush_clone_offset = {
	...
	NULL, NULL, Brush_clone_offset_get, Brush_clone_offset_set, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, -1.0f, 1.0f, -FLT_MAX, FLT_MAX, 10.0f, 3, 0.0f, rna_Brush_clone_offset_default
};
...
FloatPropertyRNA rna_BrushGpencilSettings_pen_strength = {
	...
	BrushGpencilSettings_pen_strength_get, BrushGpencilSettings_pen_strength_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 1.0f, 0.0f, 1.0f, 0.0010000000f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_BrushGpencilSettings_pen_jitter = {
	...
	BrushGpencilSettings_pen_jitter_get, BrushGpencilSettings_pen_jitter_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 1.0f, 0.0f, 1.0f, 10.0f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_BrushGpencilSettings_random_pressure = {
	...
	BrushGpencilSettings_random_pressure_get, BrushGpencilSettings_random_pressure_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 1.0f, 0.0f, 1.0f, 10.0f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_BrushGpencilSettings_random_strength = {
	...
	BrushGpencilSettings_random_strength_get, BrushGpencilSettings_random_strength_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 1.0f, 0.0f, 1.0f, 10.0f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_BrushGpencilSettings_angle = {
	...
	BrushGpencilSettings_angle_get, BrushGpencilSettings_angle_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, -1.5707963705f, 1.5707963705f, -1.5707963705f, 1.5707963705f, 10.0f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_BrushGpencilSettings_angle_factor = {
	...
	BrushGpencilSettings_angle_factor_get, BrushGpencilSettings_angle_factor_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 1.0f, 0.0f, 1.0f, 10.0f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_BrushGpencilSettings_pen_smooth_factor = {
	...
	BrushGpencilSettings_pen_smooth_factor_get, BrushGpencilSettings_pen_smooth_factor_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 1.0f, 0.0f, 2.0f, 10.0f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_BrushGpencilSettings_simplify_factor = {
	...
	BrushGpencilSettings_simplify_factor_get, BrushGpencilSettings_simplify_factor_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 100.0f, 0.0f, 100.0f, 1.0f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_BrushGpencilSettings_fill_threshold = {
	...
	BrushGpencilSettings_fill_threshold_get, BrushGpencilSettings_fill_threshold_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 1.0f, 0.0f, 1.0f, 10.0f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_BrushGpencilSettings_fill_factor = {
	...
	BrushGpencilSettings_fill_factor_get, BrushGpencilSettings_fill_factor_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0500000007f, 8.0f, 0.0500000007f, 8.0f, 10.0f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_BrushGpencilSettings_uv_random = {
	...
	BrushGpencilSettings_uv_random_get, BrushGpencilSettings_uv_random_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 1.0f, 0.0f, 1.0f, 10.0f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_BrushGpencilSettings_hardness = {
	...
	BrushGpencilSettings_hardness_get, BrushGpencilSettings_hardness_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0010000000f, 1.0f, 0.0010000000f, 1.0f, 10.0f, 3, 1.0f, NULL
};
...
FloatPropertyRNA rna_BrushGpencilSettings_aspect = {
	...
	NULL, NULL, BrushGpencilSettings_aspect_get, BrushGpencilSettings_aspect_set, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0099999998f, 1.0f, 0.0099999998f, 1.0f, 10.0f, 3, 1.0f, rna_BrushGpencilSettings_aspect_default
};
...
FloatPropertyRNA rna_BrushGpencilSettings_active_smooth_factor = {
	...
	BrushGpencilSettings_active_smooth_factor_get, BrushGpencilSettings_active_smooth_factor_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 1.0f, 0.0f, 1.0f, 10.0f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_BrushGpencilSettings_eraser_strength_factor = {
	...
	BrushGpencilSettings_eraser_strength_factor_get, BrushGpencilSettings_eraser_strength_factor_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 100.0f, 0.0f, 100.0f, 10.0f, 1, 0.0f, NULL
};
...
FloatPropertyRNA rna_BrushGpencilSettings_eraser_thickness_factor = {
	...
	BrushGpencilSettings_eraser_thickness_factor_get, BrushGpencilSettings_eraser_thickness_factor_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 100.0f, 0.0f, 100.0f, 10.0f, 1, 0.0f, NULL
};
...
EnumPropertyRNA rna_BrushGpencilSettings_gpencil_weight_icon = {
	...
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	offsetof(BrushGpencilSettings, icon_id), 0, NULL},
	BrushGpencilSettings_gpencil_weight_icon_get, BrushGpencilSettings_gpencil_weight_icon_set, NULL, NULL, NULL, rna_BrushGpencilSettings_gpencil_weight_icon_items, 4, 28
};
...
FloatPropertyRNA rna_BrushGpencilSettings_vertex_color_factor = {
	...
	BrushGpencilSettings_vertex_color_factor_get, BrushGpencilSettings_vertex_color_factor_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 1.0f, 0.0f, 1.0f, 10.0f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_BrushGpencilSettings_random_hue_factor = {
	...
	BrushGpencilSettings_random_hue_factor_get, BrushGpencilSettings_random_hue_factor_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 1.0f, 0.0f, 1.0f, 10.0f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_BrushGpencilSettings_random_saturation_factor = {
	...
	BrushGpencilSettings_random_saturation_factor_get, BrushGpencilSettings_random_saturation_factor_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 1.0f, 0.0f, 1.0f, 10.0f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_BrushGpencilSettings_random_value_factor = {
	...
	BrushGpencilSettings_random_value_factor_get, BrushGpencilSettings_random_value_factor_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 1.0f, 0.0f, 1.0f, 10.0f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_BrushGpencilSettings_extend_stroke_factor = {
	...
	BrushGpencilSettings_extend_stroke_factor_get, BrushGpencilSettings_extend_stroke_factor_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 10.0f, 0.0f, 10.0f, 10.0f, 3, 0.0f, NULL
};
...
EnumPropertyRNA rna_BrushGpencilSettings_fill_extend_mode = {
	...
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	offsetof(BrushGpencilSettings, fill_extend_mode), 0, NULL},
	BrushGpencilSettings_fill_extend_mode_get, BrushGpencilSettings_fill_extend_mode_set, NULL, NULL, NULL, rna_BrushGpencilSettings_fill_extend_mode_items, 2, 0
};
...
FloatPropertyRNA rna_BrushGpencilSettings_outline_thickness_factor = {
	...
	PROP_FLOAT, PROP_FACTOR | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	offsetof(BrushGpencilSettings, outline_fac), 5, NULL},
	BrushGpencilSettings_outline_thickness_factor_get, BrushGpencilSettings_outline_thickness_factor_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 1.0f, 0.0f, 1.0f, 10.0f, 3, 0.0f, NULL
};
...
BoolPropertyRNA rna_BrushGpencilSettings_use_settings_outline = {
	...
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	BrushGpencilSettings_use_settings_outline_get, BrushGpencilSettings_use_settings_outline_set, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};
...
PointerPropertyRNA rna_BrushGpencilSettings_material_alt = {
	...
	(UpdateFunc)rna_Brush_material_update, 391839744, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	BrushGpencilSettings_material_alt_get, BrushGpencilSettings_material_alt_set, NULL, rna_BrushGpencilSettings_material_poll,&RNA_Material
};
...
BoolPropertyRNA rna_BrushGpencilSettings_use_collide_strokes = {
	...
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	BrushGpencilSettings_use_collide_strokes_get, BrushGpencilSettings_use_collide_strokes_set, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};
...
FloatPropertyRNA rna_BrushCurvesSculptSettings_minimum_length = {
	...
	BrushCurvesSculptSettings_minimum_length_get, BrushCurvesSculptSettings_minimum_length_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, FLT_MAX, 0.0f, FLT_MAX, 10.0f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_BrushCurvesSculptSettings_curve_length = {
	...
	BrushCurvesSculptSettings_curve_length_get, BrushCurvesSculptSettings_curve_length_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, FLT_MAX, 0.0f, FLT_MAX, 10.0f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_BrushCurvesSculptSettings_minimum_distance = {
	...
	BrushCurvesSculptSettings_minimum_distance_get, BrushCurvesSculptSettings_minimum_distance_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 1000.0f, 0.0f, FLT_MAX, 0.0010000000f, 2, 0.0f, NULL
};
...
PointerPropertyRNA rna_BrushCurvesSculptSettings_curve_parameter_falloff = {
	{NULL, (PropertyRNA *)&rna_BrushCurvesSculptSettings_density_mode,
	...
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	BrushCurvesSculptSettings_curve_parameter_falloff_get, NULL, NULL, NULL,&RNA_CurveMapping
};
...
FloatPropertyRNA rna_BrushTextureSlot_angle = {
	...
	BrushTextureSlot_angle_get, BrushTextureSlot_angle_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 6.2831854820f, 0.0f, 6.2831854820f, 10.0f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_BrushTextureSlot_random_angle = {
	...
	BrushTextureSlot_random_angle_get, BrushTextureSlot_random_angle_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 6.2831854820f, 0.0f, 6.2831854820f, 10.0f, 3, 6.2831854820f, NULL
};
...
FloatPropertyRNA rna_OperatorStrokeElement_location = {
	...
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, -10000.0f, 10000.0f, -FLT_MAX, FLT_MAX, 10.0f, 3, 0.0f, rna_OperatorStrokeElement_location_default
};
...
FloatPropertyRNA rna_OperatorStrokeElement_mouse = {
	...
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, -10000.0f, 10000.0f, -FLT_MAX, FLT_MAX, 10.0f, 3, 0.0f, rna_OperatorStrokeElement_mouse_default
};
...
FloatPropertyRNA rna_OperatorStrokeElement_mouse_event = {
	...
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, -10000.0f, 10000.0f, -FLT_MAX, FLT_MAX, 10.0f, 3, 0.0f, rna_OperatorStrokeElement_mouse_event_default
};
...
FloatPropertyRNA rna_OperatorStrokeElement_pressure = {
	...
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 1.0f, 0.0f, 1.0f, 10.0f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_OperatorStrokeElement_size = {
	...
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, FLT_MAX, 0.0f, FLT_MAX, 10.0f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_OperatorStrokeElement_x_tilt = {
	...
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, -1.0f, 1.0f, -1.0f, 1.0f, 10.0f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_OperatorStrokeElement_time = {
	...
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 10000.0f, 0.0f, FLT_MAX, 10.0f, 3, 0.0f, NULL
};

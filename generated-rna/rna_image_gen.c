...
void Image_seam_margin_set(PointerRNA *ptr, int value)
{
    ...
    { BLI_STATIC_ASSERT((TYPEOF_MAX(data->seam_margin) >= 32767) && (TYPEOF_MIN(data->seam_margin) <= -32768), "invalid limits"); }
}
...
void ImageUser_tile_set(PointerRNA *ptr, int value)
{
    ...
    { BLI_STATIC_ASSERT((TYPEOF_MAX(data->tile) >= 2147483647) && (TYPEOF_MIN(data->tile) <= 0), "invalid limits"); }
}
...
void Image_save_func(struct Image *_self, Main *bmain, bContext *C, ReportList *reports, const char * filepath, int quality)
{
...
EnumPropertyRNA rna_UDIMTile_generated_type = {
	...
	rna_UDIMTile_generated_update, 187891712, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	offsetof(ImageTile, gen_type), 2, NULL},
	UDIMTile_generated_type_get, UDIMTile_generated_type_set, NULL, NULL, NULL, rna_enum_image_generated_type_items, 3, 0
};
...
IntPropertyRNA rna_UDIMTile_generated_width = {
	...
	rna_UDIMTile_generated_update, 187891712, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	offsetof(ImageTile, gen_x), 0, NULL},
	UDIMTile_generated_width_get, UDIMTile_generated_width_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL,
	0, 1, 65536, 1, 65536, 1, 0, NULL
};
...
IntPropertyRNA rna_UDIMTile_generated_height = {
	...
	PROP_INT, PROP_PIXEL | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_UDIMTile_generated_update, 187891712, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	offsetof(ImageTile, gen_y), 0, NULL},
	UDIMTile_generated_height_get, UDIMTile_generated_height_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL,
	0, 1, 65536, 1, 65536, 1, 0, NULL
};
...
BoolPropertyRNA rna_UDIMTile_use_generated_float = {
	...
	rna_UDIMTile_generated_update, 187891712, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	UDIMTile_use_generated_float_get, UDIMTile_use_generated_float_set, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};
...
FloatPropertyRNA rna_UDIMTile_generated_color = {
	{NULL, (PropertyRNA *)&rna_UDIMTile_use_generated_float,
	...
	rna_UDIMTile_generated_update, 187891712, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	offsetof(ImageTile, gen_color), 5, NULL},
	NULL, NULL, UDIMTile_generated_color_get, UDIMTile_generated_color_set, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 1.0f, 0.0f, FLT_MAX, 10.0f, 3, 0.0f, rna_UDIMTile_generated_color_default
};
...
EnumPropertyRNA rna_Image_file_format = {
	...
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	Image_file_format_get, Image_file_format_set, NULL, NULL, NULL, rna_enum_image_type_items, 18, 0
};
...
FloatPropertyRNA rna_Image_generated_color = {
	...
	rna_Image_generated_update, 187891712, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	NULL, NULL, Image_generated_color_get, Image_generated_color_set, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 1.0f, 0.0f, FLT_MAX, 10.0f, 3, 0.0f, rna_Image_generated_color_default
};
...
FloatPropertyRNA rna_Image_display_aspect = {
	...
	NULL, NULL, Image_display_aspect_get, Image_display_aspect_set, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.1000000015f, 5000.0f, 0.1000000015f, FLT_MAX, 1.0f, 2, 1.0f, rna_Image_display_aspect_default
};
...
FloatPropertyRNA rna_Image_resolution = {
	...
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	NULL, NULL, Image_resolution_get, Image_resolution_set, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 0.0f, -FLT_MAX, FLT_MAX, 1.0f, 3, 0.0f, rna_Image_resolution_default
};
...
FloatPropertyRNA rna_Image_pixels = {
	...
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	NULL, NULL, Image_pixels_get, Image_pixels_set, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, -10000.0f, 10000.0f, -FLT_MAX, FLT_MAX, 10.0f, 3, 0.0f, NULL
};
...
IntPropertyRNA rna_Image_seam_margin = {
	...
	PROP_INT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	offsetof(Image, seam_margin), 1, NULL},
	Image_seam_margin_get, Image_seam_margin_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL,
	0, 1, 100, -32768, 32767, 1, 8, NULL
};
...
IntPropertyRNA rna_Image_save_render_quality = {
	{NULL, (PropertyRNA *)&rna_Image_save_render_scene,
...
StringPropertyRNA rna_Image_save_filepath = {
	{(PropertyRNA *)&rna_Image_save_quality, NULL,
...
IntPropertyRNA rna_Image_save_quality = {
	{NULL, (PropertyRNA *)&rna_Image_save_filepath,
	-1, "quality", 3, 0, 0, 0, 0, "Quality",
	"Quality for image formats that support lossy compression, uses default quality if not specified",
	0, "*",
	PROP_INT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,

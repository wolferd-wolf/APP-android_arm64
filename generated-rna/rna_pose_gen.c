...
{
    PropIntGetFunc fn = rna_Pose_active_bone_group_index_get;
    return fn(ptr);
}

void BoneGroups_active_index_set(PointerRNA *ptr, int value)
{
    PropIntSetFunc fn = rna_Pose_active_bone_group_index_set;
    fn(ptr, value);
}
...
{
    PropIntGetFunc fn = rna_PoseChannel_bone_group_index_get;
    return fn(ptr);
}

void PoseBone_bone_group_index_set(PointerRNA *ptr, int value)
{
    PropIntSetFunc fn = rna_PoseChannel_bone_group_index_set;
    fn(ptr, value);
}
...
void Pose_blend_pose_from_action_func(struct ID *_selfid, bContext *C, struct bAction *action, float blend_factor, float evaluation_time)
{
	rna_Pose_blend_pose_from_action(_selfid, C, action, blend_factor, evaluation_time);
}

void Pose_blend_pose_from_action_call(bContext *C, ReportList *reports, PointerRNA *_ptr, ParameterList *_parms)
{
	struct ID *_selfid;
	struct bAction *action;
	float blend_factor;
...
void Pose_backup_create_func(struct ID *_selfid, struct bAction *action)
{
	rna_Pose_backup_create(_selfid, action);
}

void Pose_backup_create_call(bContext *C, ReportList *reports, PointerRNA *_ptr, ParameterList *_parms)
{
	struct ID *_selfid;
	struct bAction *action;
	char *_data;
...
bool Pose_backup_restore_func(struct ID *_selfid, bContext *C)
{
	return rna_Pose_backup_restore(_selfid, C);
}

void Pose_backup_restore_call(bContext *C, ReportList *reports, PointerRNA *_ptr, ParameterList *_parms)
{
	struct ID *_selfid;
	bool success;
	char *_data, *_retdata;
...
void Pose_backup_clear_func(struct ID *_selfid)
{
	rna_Pose_backup_clear(_selfid);
}

void Pose_backup_clear_call(bContext *C, ReportList *reports, PointerRNA *_ptr, ParameterList *_parms)
{
	struct ID *_selfid;
	_selfid = (struct ID *)_ptr->owner_id;
...
FunctionRNA rna_Pose_apply_pose_from_action_func = {
	{(FunctionRNA *)&rna_Pose_blend_pose_from_action_func, NULL,
	NULL,
...
PointerPropertyRNA rna_Pose_blend_pose_from_action_action = {
	{(PropertyRNA *)&rna_Pose_blend_pose_from_action_blend_factor, NULL,
	-1, "action", 8388736, 0, 1, 0, 0, "Action",
	"The Action containing the pose",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
...
FloatPropertyRNA rna_Pose_blend_pose_from_action_evaluation_time = {
	{NULL, (PropertyRNA *)&rna_Pose_blend_pose_from_action_blend_factor,
	-1, "evaluation_time", 3, 0, 0, 0, 0, "Evaluation Time",
	"Time at which the given action is evaluated to obtain the pose",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
...
FunctionRNA rna_Pose_backup_clear_func = {
	{NULL, (FunctionRNA *)&rna_Pose_backup_restore_func,
	NULL,
	{NULL, NULL}},
...
FloatPropertyRNA rna_PoseBone_location = {
	...
	NULL, NULL, PoseBone_location_get, PoseBone_location_set, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, -FLT_MAX, FLT_MAX, -FLT_MAX, FLT_MAX, 1.0f, 5, 0.0f, rna_PoseBone_location_default
};
...
FloatPropertyRNA rna_PoseBone_scale = {
	...
	NULL, NULL, PoseBone_scale_get, PoseBone_scale_set, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, -10000.0f, 10000.0f, -FLT_MAX, FLT_MAX, 10.0f, 3, 0.0f, rna_PoseBone_scale_default
};
...
FloatPropertyRNA rna_PoseBone_rotation_quaternion = {
	...
	NULL, NULL, PoseBone_rotation_quaternion_get, PoseBone_rotation_quaternion_set, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, -10000.0f, 10000.0f, -FLT_MAX, FLT_MAX, 10.0f, 3, 0.0f, rna_PoseBone_rotation_quaternion_default
};
...
FloatPropertyRNA rna_PoseBone_rotation_axis_angle = {
	...
	rna_Pose_update, 101974016, NULL, rna_PoseChannel_rotation_4d_editable, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	NULL, NULL, PoseBone_rotation_axis_angle_get, PoseBone_rotation_axis_angle_set, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, -10000.0f, 10000.0f, -FLT_MAX, FLT_MAX, 10.0f, 3, 0.0f, rna_PoseBone_rotation_axis_angle_default
};
...
FloatPropertyRNA rna_PoseBone_rotation_euler = {
	...
	NULL, NULL, PoseBone_rotation_euler_get, PoseBone_rotation_euler_set, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, -FLT_MAX, FLT_MAX, -FLT_MAX, FLT_MAX, 100.0f, 5, 0.0f, rna_PoseBone_rotation_euler_default
};
...
FloatPropertyRNA rna_PoseBone_bbone_rollin = {
	...
	PoseBone_bbone_rollin_get, PoseBone_bbone_rollin_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, -6.2831854820f, 6.2831854820f, -FLT_MAX, FLT_MAX, 10.0f, 2, 0.0f, NULL
};
...
FloatPropertyRNA rna_PoseBone_bbone_rollout = {
	...
	PoseBone_bbone_rollout_get, PoseBone_bbone_rollout_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, -6.2831854820f, 6.2831854820f, -FLT_MAX, FLT_MAX, 10.0f, 2, 0.0f, NULL
};
...
FloatPropertyRNA rna_PoseBone_bbone_curveinx = {
	...
	PoseBone_bbone_curveinx_get, PoseBone_bbone_curveinx_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, -FLT_MAX, FLT_MAX, -FLT_MAX, FLT_MAX, 1.0f, 5, 0.0f, NULL
};
...
FloatPropertyRNA rna_PoseBone_bbone_curveinz = {
	...
	PoseBone_bbone_curveinz_get, PoseBone_bbone_curveinz_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, -FLT_MAX, FLT_MAX, -FLT_MAX, FLT_MAX, 1.0f, 5, 0.0f, NULL
};
...
FloatPropertyRNA rna_PoseBone_bbone_curveoutx = {
	...
	PoseBone_bbone_curveoutx_get, PoseBone_bbone_curveoutx_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, -FLT_MAX, FLT_MAX, -FLT_MAX, FLT_MAX, 1.0f, 5, 0.0f, NULL
};
...
FloatPropertyRNA rna_PoseBone_bbone_curveoutz = {
	...
	PoseBone_bbone_curveoutz_get, PoseBone_bbone_curveoutz_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, -FLT_MAX, FLT_MAX, -FLT_MAX, FLT_MAX, 1.0f, 5, 0.0f, NULL
};
...
FloatPropertyRNA rna_PoseBone_bbone_easein = {
	...
	PoseBone_bbone_easein_get, PoseBone_bbone_easein_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, -5.0f, 5.0f, -FLT_MAX, FLT_MAX, 1.0f, 3, 1.0f, NULL
};
...
FloatPropertyRNA rna_PoseBone_bbone_easeout = {
	...
	PoseBone_bbone_easeout_get, PoseBone_bbone_easeout_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, -5.0f, 5.0f, -FLT_MAX, FLT_MAX, 1.0f, 3, 1.0f, NULL
};
...
FloatPropertyRNA rna_PoseBone_bbone_scalein = {
	...
	NULL, NULL, PoseBone_bbone_scalein_get, PoseBone_bbone_scalein_set, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, FLT_MAX, -FLT_MAX, FLT_MAX, 1.0f, 3, 0.0f, rna_PoseBone_bbone_scalein_default
};
...
FloatPropertyRNA rna_PoseBone_bbone_scaleout = {
	...
	NULL, NULL, PoseBone_bbone_scaleout_get, PoseBone_bbone_scaleout_set, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, FLT_MAX, -FLT_MAX, FLT_MAX, 1.0f, 3, 0.0f, rna_PoseBone_bbone_scaleout_default
};
...
FloatPropertyRNA rna_PoseBone_matrix_channel = {
	...
	NULL, NULL, PoseBone_matrix_channel_get, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, -10000.0f, 10000.0f, -FLT_MAX, FLT_MAX, 10.0f, 3, 0.0f, rna_PoseBone_matrix_channel_default
};
...
FloatPropertyRNA rna_PoseBone_matrix_basis = {
	...
	rna_Pose_update, 101974016, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	NULL, NULL, PoseBone_matrix_basis_get, PoseBone_matrix_basis_set, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, -10000.0f, 10000.0f, -FLT_MAX, FLT_MAX, 10.0f, 3, 0.0f, rna_PoseBone_matrix_basis_default
};
...
FloatPropertyRNA rna_PoseBone_matrix = {
	...
	rna_Pose_update, 101974016, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	NULL, NULL, PoseBone_matrix_get, PoseBone_matrix_set, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, -10000.0f, 10000.0f, -FLT_MAX, FLT_MAX, 10.0f, 3, 0.0f, rna_PoseBone_matrix_default
};
...
FloatPropertyRNA rna_PoseBone_head = {
	...
	NULL, NULL, PoseBone_head_get, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, -FLT_MAX, FLT_MAX, -FLT_MAX, FLT_MAX, 1.0f, 5, 0.0f, rna_PoseBone_head_default
};
...
FloatPropertyRNA rna_PoseBone_tail = {
	...
	NULL, NULL, PoseBone_tail_get, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, -FLT_MAX, FLT_MAX, -FLT_MAX, FLT_MAX, 1.0f, 5, 0.0f, rna_PoseBone_tail_default
};
...
FloatPropertyRNA rna_PoseBone_length = {
	...
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	PoseBone_length_get, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, -10000.0f, 10000.0f, -FLT_MAX, FLT_MAX, 10.0f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_PoseBone_ik_min_x = {
	...
	PoseBone_ik_min_x_get, PoseBone_ik_min_x_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, -3.1415927410f, 0.0f, -3.1415927410f, 0.0f, 10.0f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_PoseBone_ik_max_x = {
	...
	PoseBone_ik_max_x_get, PoseBone_ik_max_x_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 3.1415927410f, 0.0f, 3.1415927410f, 10.0f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_PoseBone_ik_min_y = {
	...
	PoseBone_ik_min_y_get, PoseBone_ik_min_y_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, -3.1415927410f, 0.0f, -3.1415927410f, 0.0f, 10.0f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_PoseBone_ik_max_y = {
	...
	PoseBone_ik_max_y_get, PoseBone_ik_max_y_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 3.1415927410f, 0.0f, 3.1415927410f, 10.0f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_PoseBone_ik_min_z = {
	...
	PoseBone_ik_min_z_get, PoseBone_ik_min_z_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, -3.1415927410f, 0.0f, -3.1415927410f, 0.0f, 10.0f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_PoseBone_ik_max_z = {
	...
	PoseBone_ik_max_z_get, PoseBone_ik_max_z_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 3.1415927410f, 0.0f, 3.1415927410f, 10.0f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_PoseBone_ik_stiffness_x = {
	...
	PoseBone_ik_stiffness_x_get, PoseBone_ik_stiffness_x_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 0.9900000095f, 0.0f, 0.9900000095f, 10.0f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_PoseBone_ik_stiffness_y = {
	...
	PoseBone_ik_stiffness_y_get, PoseBone_ik_stiffness_y_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 0.9900000095f, 0.0f, 0.9900000095f, 10.0f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_PoseBone_ik_stiffness_z = {
	...
	PoseBone_ik_stiffness_z_get, PoseBone_ik_stiffness_z_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 0.9900000095f, 0.0f, 0.9900000095f, 10.0f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_PoseBone_ik_stretch = {
	...
	PoseBone_ik_stretch_get, PoseBone_ik_stretch_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 1.0f, 0.0f, 1.0f, 10.0f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_PoseBone_ik_rotation_weight = {
	...
	PoseBone_ik_rotation_weight_get, PoseBone_ik_rotation_weight_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 1.0f, 0.0f, 1.0f, 10.0f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_PoseBone_ik_linear_weight = {
	...
	PoseBone_ik_linear_weight_get, PoseBone_ik_linear_weight_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 1.0f, 0.0f, 1.0f, 10.0f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_PoseBone_custom_shape_scale_xyz = {
	...
	NULL, NULL, PoseBone_custom_shape_scale_xyz_get, PoseBone_custom_shape_scale_xyz_set, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, -10000.0f, 10000.0f, -FLT_MAX, FLT_MAX, 10.0f, 3, 0.0f, rna_PoseBone_custom_shape_scale_xyz_default
};
...
FloatPropertyRNA rna_PoseBone_custom_shape_translation = {
	...
	NULL, NULL, PoseBone_custom_shape_translation_get, PoseBone_custom_shape_translation_set, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, -FLT_MAX, FLT_MAX, -FLT_MAX, FLT_MAX, 1.0f, 5, 0.0f, rna_PoseBone_custom_shape_translation_default
};
...
FloatPropertyRNA rna_PoseBone_custom_shape_rotation_euler = {
	...
	NULL, NULL, PoseBone_custom_shape_rotation_euler_get, PoseBone_custom_shape_rotation_euler_set, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, -FLT_MAX, FLT_MAX, -FLT_MAX, FLT_MAX, 100.0f, 5, 0.0f, rna_PoseBone_custom_shape_rotation_euler_default
};
...
FloatPropertyRNA rna_PoseBone_evaluate_envelope_point = {
	...
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, -FLT_MAX, FLT_MAX, -FLT_MAX, FLT_MAX, 1.0f, 3, 0.0f, rna_PoseBone_evaluate_envelope_point_default
};
...
FloatPropertyRNA rna_PoseBone_bbone_segment_matrix_matrix_return = {
	...
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, -10000.0f, 10000.0f, -FLT_MAX, FLT_MAX, 10.0f, 3, 0.0f, rna_PoseBone_bbone_segment_matrix_matrix_return_default
};
...
FloatPropertyRNA rna_PoseBone_compute_bbone_handles_handle1 = {
	...
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, -10000.0f, 10000.0f, -FLT_MAX, FLT_MAX, 10.0f, 3, 0.0f, rna_PoseBone_compute_bbone_handles_handle1_default
};
...
FloatPropertyRNA rna_PoseBone_compute_bbone_handles_handle2 = {
	...
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, -10000.0f, 10000.0f, -FLT_MAX, FLT_MAX, 10.0f, 3, 0.0f, rna_PoseBone_compute_bbone_handles_handle2_default
};
...
FloatPropertyRNA rna_Itasc_precision = {
	...
	Itasc_precision_get, Itasc_precision_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 0.1000000015f, 0.0f, 0.1000000015f, 10.0f, 3, 0.0f, NULL
};
...
BoolPropertyRNA rna_Itasc_translate_root_bones = {
	...
	rna_Itasc_update, 101974016, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	Itasc_translate_root_bones_get, Itasc_translate_root_bones_set, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};
...
FloatPropertyRNA rna_Itasc_step_min = {
	...
	Itasc_step_min_get, Itasc_step_min_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 0.1000000015f, 0.0f, 0.1000000015f, 10.0f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_Itasc_step_max = {
	...
	Itasc_step_max_get, Itasc_step_max_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 1.0f, 0.0f, 1.0f, 10.0f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_Itasc_feedback = {
	...
	Itasc_feedback_get, Itasc_feedback_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 100.0f, 0.0f, 100.0f, 10.0f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_Itasc_velocity_max = {
	...
	Itasc_velocity_max_get, Itasc_velocity_max_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 100.0f, 0.0f, 100.0f, 10.0f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_Itasc_damping_max = {
	...
	Itasc_damping_max_get, Itasc_damping_max_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 1.0f, 0.0f, 1.0f, 10.0f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_Itasc_damping_epsilon = {
	...
	Itasc_damping_epsilon_get, Itasc_damping_epsilon_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 1.0f, 0.0f, 1.0f, 10.0f, 3, 0.0f, NULL
};

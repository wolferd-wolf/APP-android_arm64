...
int Curves_points_lookup_int(PointerRNA *ptr, int index, PointerRNA *r_ptr)
{
...
int Curves_position_data_lookup_int(PointerRNA *ptr, int index, PointerRNA *r_ptr)
{
...
int FloatVectorValueReadOnly_rna_properties_lookup_string(PointerRNA *ptr, const char *key, PointerRNA *r_ptr)
{
    return rna_builtin_properties_lookup_string(ptr, key, r_ptr);
}
...
FloatPropertyRNA rna_CurvePoint_position = {
	...
	0, -1, NULL},
	NULL, NULL, CurvePoint_position_get, CurvePoint_position_set, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, -10000.0f, 10000.0f, -FLT_MAX, FLT_MAX, 10.0f, 3, 0.0f, rna_CurvePoint_position_default
};
...
FloatPropertyRNA rna_CurvePoint_radius = {
	...
	rna_Curves_update_data, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	CurvePoint_radius_get, CurvePoint_radius_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, -10000.0f, 10000.0f, -FLT_MAX, FLT_MAX, 10.0f, 3, 0.0f, NULL
};
...
CollectionPropertyRNA rna_Curves_points = {
	...
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	Curves_points_begin, Curves_points_next, Curves_points_end, Curves_points_get, Curves_points_length, Curves_points_lookup_int, NULL, NULL, &RNA_CurvePoint
};
...
CollectionPropertyRNA rna_Curves_position_data = {
	...
	rna_Curves_update_data, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	Curves_position_data_begin, Curves_position_data_next, Curves_position_data_end, Curves_position_data_get, Curves_position_data_length, Curves_position_data_lookup_int, NULL, NULL, &RNA_FloatVectorAttributeValue
};
...
CollectionPropertyRNA rna_Curves_normals = {
	...
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	Curves_normals_begin, Curves_normals_next, Curves_normals_end, Curves_normals_get, Curves_normals_length, NULL, NULL, NULL, &RNA_FloatVectorValueReadOnly
};
...
BoolPropertyRNA rna_Curves_use_sculpt_collision = {
	...
	rna_Curves_update_draw, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	Curves_use_sculpt_collision_get, Curves_use_sculpt_collision_set, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};
...
/* Read-Only Vector */
CollectionPropertyRNA rna_FloatVectorValueReadOnly_rna_properties = {
	{(PropertyRNA *)&rna_FloatVectorValueReadOnly_rna_type, NULL,
	-1, "rna_properties", 0, 0, 0, 1, 0, "Properties",
	"RNA property collection",
	0, "*",
	PROP_COLLECTION, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	FloatVectorValueReadOnly_rna_properties_begin, FloatVectorValueReadOnly_rna_properties_next, FloatVectorValueReadOnly_rna_properties_end, FloatVectorValueReadOnly_rna_properties_get, NULL, NULL, FloatVectorValueReadOnly_rna_properties_lookup_string, NULL, &RNA_Property
};
...
PointerPropertyRNA rna_FloatVectorValueReadOnly_rna_type = {
	...
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	FloatVectorValueReadOnly_rna_type_get, NULL, NULL, NULL,&RNA_Struct
};
...
FloatPropertyRNA rna_FloatVectorValueReadOnly_vector = {
	{NULL, (PropertyRNA *)&rna_FloatVectorValueReadOnly_rna_type,
	...
	NULL, NULL, FloatVectorValueReadOnly_vector_get, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, -10000.0f, 10000.0f, -FLT_MAX, FLT_MAX, 10.0f, 3, 0.0f, rna_FloatVectorValueReadOnly_vector_default
};
...
StructRNA RNA_FloatVectorValueReadOnly = {
	...
	"FloatVectorValueReadOnly", NULL, NULL, 516, NULL, "Read-Only Vector",
	"",
	"*", 17,
	NULL, (PropertyRNA *)&rna_FloatVectorValueReadOnly_rna_properties,
	NULL,
	NULL,
	NULL,
	NULL,

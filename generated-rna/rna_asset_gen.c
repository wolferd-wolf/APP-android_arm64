...
void AssetMetaData_active_tag_set(PointerRNA *ptr, int value)
{
    ...
    data->active_tag = CLAMPIS(value, prop_clamp_min, prop_clamp_max);    { BLI_STATIC_ASSERT((TYPEOF_MAX(data->active_tag) >= 32767) && (TYPEOF_MIN(data->active_tag) <= -32768), "invalid limits"); }
}
...
int AssetRepresentation_rna_properties_lookup_string(PointerRNA *ptr, const char *key, PointerRNA *r_ptr)
{
    return rna_builtin_properties_lookup_string(ptr, key, r_ptr);
}
...
void AssetCatalogPath_rna_properties_begin(CollectionPropertyIterator *iter, PointerRNA *ptr)
{
...
void AssetCatalogPath_rna_properties_next(CollectionPropertyIterator *iter)
{
    rna_builtin_properties_next(iter);
...
void AssetCatalogPath_rna_properties_end(CollectionPropertyIterator *iter)
{
    rna_iterator_listbase_end(iter);
}

int AssetCatalogPath_rna_properties_lookup_string(PointerRNA *ptr, const char *key, PointerRNA *r_ptr)
{
    return rna_builtin_properties_lookup_string(ptr, key, r_ptr);
}

PointerRNA AssetCatalogPath_rna_type_get(PointerRNA *ptr)
{
    return rna_builtin_type_get(ptr);
}
...
void AssetHandle_get_full_library_path_func(struct FileDirEntry *asset_file_handle, struct AssetLibraryReference *asset_library_ref, char * result)
{
	rna_AssetHandle_get_full_library_path(asset_file_handle, asset_library_ref, result);
}
...
void rna_AssetHandle_get_full_library_path(struct FileDirEntry *asset_file_handle, struct AssetLibraryReference *asset_library_ref, char * result);
...
StringPropertyRNA rna_AssetMetaData_copyright = {
	...
	NULL, 0, rna_AssetMetaData_editable, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	AssetMetaData_copyright_get, AssetMetaData_copyright_length, AssetMetaData_copyright_set, NULL, NULL, NULL, NULL, 0, 0, ""
};
...
StringPropertyRNA rna_AssetMetaData_license = {
	...
	NULL, 0, rna_AssetMetaData_editable, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	AssetMetaData_license_get, AssetMetaData_license_length, AssetMetaData_license_set, NULL, NULL, NULL, NULL, 0, 0, ""
};
...
PointerPropertyRNA rna_AssetHandle_get_full_library_path_asset_library_ref = {
	...
	-1, "asset_library_ref", 8388608, 0, 0, 0, 0, "",
	"The asset library containing the given asset. Deprecated and optional argument, will be ignored. Kept for API compatibility only",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
...
FunctionRNA rna_AssetHandle_get_full_library_path_func = {
	...
	"get_full_library_path", 1, "get_full_library_path",
...
CollectionPropertyRNA rna_AssetRepresentation_rna_properties = {
	{(PropertyRNA *)&rna_AssetRepresentation_rna_type, NULL,
	-1, "rna_properties", 0, 0, 0, 1, 0, "Properties",
	"RNA property collection",
	0, "*",
	PROP_COLLECTION, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	AssetRepresentation_rna_properties_begin, AssetRepresentation_rna_properties_next, AssetRepresentation_rna_properties_end, AssetRepresentation_rna_properties_get, NULL, NULL, AssetRepresentation_rna_properties_lookup_string, NULL, &RNA_Property
};

PointerPropertyRNA rna_AssetRepresentation_rna_type = {
	{NULL, (PropertyRNA *)&rna_AssetRepresentation_rna_properties,
	-1, "rna_type", 8912896, 0, 0, 0, 0, "RNA",
	"RNA type definition",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	AssetRepresentation_rna_type_get, NULL, NULL, NULL,&RNA_Struct
};

StructRNA RNA_AssetRepresentation = {
	{(ContainerRNA *)&RNA_AssetCatalogPath, (ContainerRNA *)&RNA_AssetHandle,
	NULL,
	{(PropertyRNA *)&rna_AssetRepresentation_rna_properties, (PropertyRNA *)&rna_AssetRepresentation_rna_type}},
	"AssetRepresentation", NULL, NULL, 516, NULL, "Asset Representation",
...
/* Catalog Path */
CollectionPropertyRNA rna_AssetCatalogPath_rna_properties = {
	{(PropertyRNA *)&rna_AssetCatalogPath_rna_type, NULL,
	-1, "rna_properties", 0, 0, 0, 1, 0, "Properties",
	"RNA property collection",
	0, "*",
	PROP_COLLECTION, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	AssetCatalogPath_rna_properties_begin, AssetCatalogPath_rna_properties_next, AssetCatalogPath_rna_properties_end, AssetCatalogPath_rna_properties_get, NULL, NULL, AssetCatalogPath_rna_properties_lookup_string, NULL, &RNA_Property
};

PointerPropertyRNA rna_AssetCatalogPath_rna_type = {
	{NULL, (PropertyRNA *)&rna_AssetCatalogPath_rna_properties,
	-1, "rna_type", 8912896, 0, 0, 0, 0, "RNA",
	"RNA type definition",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	AssetCatalogPath_rna_type_get, NULL, NULL, NULL,&RNA_Struct
};
...
StructRNA RNA_AssetCatalogPath = {
	...
	"AssetCatalogPath", NULL, NULL, 516, NULL, "Catalog Path",
	"",
	"*", 17,
	NULL, (PropertyRNA *)&rna_AssetCatalogPath_rna_properties,
	NULL,

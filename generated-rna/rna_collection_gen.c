...
void Collection_lineart_intersection_priority_set(PointerRNA *ptr, int value)
{
    ...
    { BLI_STATIC_ASSERT((TYPEOF_MAX(data->lineart_intersection_priority) >= 255) && (TYPEOF_MIN(data->lineart_intersection_priority) <= 0), "invalid limits"); }
}
...
FloatPropertyRNA rna_Collection_instance_offset = {
	...
	NULL, NULL, Collection_instance_offset_get, Collection_instance_offset_set, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, -10000.0f, 10000.0f, -FLT_MAX, FLT_MAX, 10.0f, 5, 0.0f, rna_Collection_instance_offset_default
};
...
EnumPropertyRNA rna_Collection_color_tag = {
	...
	0, -1, NULL},
	Collection_color_tag_get, Collection_color_tag_set, NULL, NULL, NULL, rna_enum_collection_color_items, 9, 0
};

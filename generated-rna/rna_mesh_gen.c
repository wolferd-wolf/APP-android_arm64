...
CollectionPropertyRNA rna_Mesh_edge_creases;
...
BoolPropertyRNA rna_Mesh_has_bevel_weight_edge;
BoolPropertyRNA rna_Mesh_has_bevel_weight_vertex;
BoolPropertyRNA rna_Mesh_has_crease_edge;
BoolPropertyRNA rna_Mesh_has_crease_vertex;
...
CollectionPropertyRNA rna_MeshEdgeCreaseLayer_rna_properties;
PointerPropertyRNA rna_MeshEdgeCreaseLayer_rna_type;
CollectionPropertyRNA rna_MeshEdgeCreaseLayer_data;


CollectionPropertyRNA rna_MeshEdgeCrease_rna_properties;
PointerPropertyRNA rna_MeshEdgeCrease_rna_type;
FloatPropertyRNA rna_MeshEdgeCrease_value;
...
int Mesh_vertex_normals_lookup_int(PointerRNA *ptr, int index, PointerRNA *r_ptr)
{
...
int Mesh_polygon_normals_lookup_int(PointerRNA *ptr, int index, PointerRNA *r_ptr)
{
...
int Mesh_corner_normals_lookup_int(PointerRNA *ptr, int index, PointerRNA *r_ptr)
{
...
int Mesh_loop_triangle_polygons_lookup_int(PointerRNA *ptr, int index, PointerRNA *r_ptr)
{
...
int Mesh_edge_creases_length(PointerRNA *ptr)
{
    return rna_Mesh_edge_creases_length(ptr);
}

static PointerRNA Mesh_edge_creases_get(CollectionPropertyIterator *iter)
{
    return rna_pointer_inherit_refine(&iter->parent, &RNA_MeshEdgeCreaseLayer, rna_iterator_array_get(iter));
}

void Mesh_edge_creases_begin(CollectionPropertyIterator *iter, PointerRNA *ptr)
{

    memset(iter, 0, sizeof(*iter));
    iter->parent = *ptr;
    iter->prop = (PropertyRNA *)&rna_Mesh_edge_creases;

    rna_Mesh_edge_creases_begin(iter, ptr);

    if (iter->valid) {
        iter->ptr = Mesh_edge_creases_get(iter);
    }
}

void Mesh_edge_creases_next(CollectionPropertyIterator *iter)
{
    rna_iterator_array_next(iter);
...
void Mesh_edge_creases_end(CollectionPropertyIterator *iter)
{
    rna_iterator_array_end(iter);
}

int Mesh_edge_creases_lookup_int(PointerRNA *ptr, int index, PointerRNA *r_ptr)
{
    int found = 0;
    CollectionPropertyIterator iter;

    Mesh_edge_creases_begin(&iter, ptr);
    ...
    if (iter.valid) {
        ...
        if (found) { *r_ptr = Mesh_edge_creases_get(&iter); }
    }

    Mesh_edge_creases_end(&iter);
...
bool Mesh_has_bevel_weight_edge_get(PointerRNA *ptr)
{
    PropBooleanGetFunc fn = rna_Mesh_has_edge_bevel_weight_get;
    return fn(ptr);
}

bool Mesh_has_bevel_weight_vertex_get(PointerRNA *ptr)
{
    PropBooleanGetFunc fn = rna_Mesh_has_vertex_bevel_weight_get;
    return fn(ptr);
}

bool Mesh_has_crease_edge_get(PointerRNA *ptr)
{
    PropBooleanGetFunc fn = rna_Mesh_has_edge_crease_get;
    return fn(ptr);
}

bool Mesh_has_crease_vertex_get(PointerRNA *ptr)
{
    PropBooleanGetFunc fn = rna_Mesh_has_vertex_crease_get;
    return fn(ptr);
}
...
int ReadOnlyInteger_rna_properties_lookup_string(PointerRNA *ptr, const char *key, PointerRNA *r_ptr)
{
    return rna_builtin_properties_lookup_string(ptr, key, r_ptr);
}
...
{
    PropIntGetFunc fn = rna_Mesh_sculpt_vertex_color_active_index_get;
    return fn(ptr);
}

void VertColors_active_index_set(PointerRNA *ptr, int value)
{
    PropIntSetFunc fn = rna_Mesh_sculpt_vertex_color_active_index_set;
    fn(ptr, value);
}
...
static PointerRNA MeshEdgeCreaseLayer_rna_properties_get(CollectionPropertyIterator *iter)
{
    return rna_builtin_properties_get(iter);
}

void MeshEdgeCreaseLayer_rna_properties_begin(CollectionPropertyIterator *iter, PointerRNA *ptr)
{

    memset(iter, 0, sizeof(*iter));
    iter->parent = *ptr;
    iter->prop = (PropertyRNA *)&rna_MeshEdgeCreaseLayer_rna_properties;

    rna_builtin_properties_begin(iter, ptr);

    if (iter->valid) {
        iter->ptr = MeshEdgeCreaseLayer_rna_properties_get(iter);
    }
}

void MeshEdgeCreaseLayer_rna_properties_next(CollectionPropertyIterator *iter)
{
    rna_builtin_properties_next(iter);
...
void MeshEdgeCreaseLayer_rna_properties_end(CollectionPropertyIterator *iter)
{
    rna_iterator_listbase_end(iter);
}

int MeshEdgeCreaseLayer_rna_properties_lookup_string(PointerRNA *ptr, const char *key, PointerRNA *r_ptr)
{
    return rna_builtin_properties_lookup_string(ptr, key, r_ptr);
}

PointerRNA MeshEdgeCreaseLayer_rna_type_get(PointerRNA *ptr)
{
    return rna_builtin_type_get(ptr);
}

int MeshEdgeCreaseLayer_data_length(PointerRNA *ptr)
{
    return rna_MeshEdgeCreaseLayer_data_length(ptr);
}

static PointerRNA MeshEdgeCreaseLayer_data_get(CollectionPropertyIterator *iter)
{
    return rna_pointer_inherit_refine(&iter->parent, &RNA_MeshEdgeCrease, rna_iterator_array_get(iter));
}

void MeshEdgeCreaseLayer_data_begin(CollectionPropertyIterator *iter, PointerRNA *ptr)
{

    memset(iter, 0, sizeof(*iter));
    iter->parent = *ptr;
    iter->prop = (PropertyRNA *)&rna_MeshEdgeCreaseLayer_data;

    rna_MeshEdgeCreaseLayer_data_begin(iter, ptr);

    if (iter->valid) {
        iter->ptr = MeshEdgeCreaseLayer_data_get(iter);
    }
}

void MeshEdgeCreaseLayer_data_next(CollectionPropertyIterator *iter)
{
    rna_iterator_array_next(iter);
...
void MeshEdgeCreaseLayer_data_end(CollectionPropertyIterator *iter)
{
    rna_iterator_array_end(iter);
}

int MeshEdgeCreaseLayer_data_lookup_int(PointerRNA *ptr, int index, PointerRNA *r_ptr)
{
    int found = 0;
    CollectionPropertyIterator iter;

    MeshEdgeCreaseLayer_data_begin(&iter, ptr);
    ...
    if (iter.valid) {
        ...
        if (found) { *r_ptr = MeshEdgeCreaseLayer_data_get(&iter); }
    }

    MeshEdgeCreaseLayer_data_end(&iter);

    return found;
}

static PointerRNA MeshEdgeCrease_rna_properties_get(CollectionPropertyIterator *iter)
{
    return rna_builtin_properties_get(iter);
}

void MeshEdgeCrease_rna_properties_begin(CollectionPropertyIterator *iter, PointerRNA *ptr)
{

    memset(iter, 0, sizeof(*iter));
    iter->parent = *ptr;
    iter->prop = (PropertyRNA *)&rna_MeshEdgeCrease_rna_properties;

    rna_builtin_properties_begin(iter, ptr);

    if (iter->valid) {
        iter->ptr = MeshEdgeCrease_rna_properties_get(iter);
    }
}

void MeshEdgeCrease_rna_properties_next(CollectionPropertyIterator *iter)
{
    rna_builtin_properties_next(iter);
...
void MeshEdgeCrease_rna_properties_end(CollectionPropertyIterator *iter)
{
    rna_iterator_listbase_end(iter);
}

int MeshEdgeCrease_rna_properties_lookup_string(PointerRNA *ptr, const char *key, PointerRNA *r_ptr)
{
    return rna_builtin_properties_lookup_string(ptr, key, r_ptr);
}

PointerRNA MeshEdgeCrease_rna_type_get(PointerRNA *ptr)
{
    return rna_builtin_type_get(ptr);
}

float MeshEdgeCrease_value_get(PointerRNA *ptr)
{
    MFloatProperty *data = (MFloatProperty *)(ptr->data);
    return (float)(data->f);
}

void MeshEdgeCrease_value_set(PointerRNA *ptr, float value)
{
    MFloatProperty *data = (MFloatProperty *)(ptr->data);
    data->f = value;
}
...
{
    PropFloatGetFunc fn = rna_MeshVertex_bevel_weight_get;
    return fn(ptr);
}

void MeshVertex_bevel_weight_set(PointerRNA *ptr, float value)
{
    PropFloatSetFunc fn = rna_MeshVertex_bevel_weight_set;
    fn(ptr, value);
}
...
void MeshEdge_vertices_set(PointerRNA *ptr, const int values[2])
{
    ...
    { BLI_STATIC_ASSERT((TYPEOF_MAX(data->x) >= 2147483647) && (TYPEOF_MIN(data->x) <= 0), "invalid limits"); }
}

float MeshEdge_crease_get(PointerRNA *ptr)
{
    PropFloatGetFunc fn = rna_MEdge_crease_get;
    return fn(ptr);
}

void MeshEdge_crease_set(PointerRNA *ptr, float value)
{
    PropFloatSetFunc fn = rna_MEdge_crease_set;
    fn(ptr, value);
}

float MeshEdge_bevel_weight_get(PointerRNA *ptr)
{
    PropFloatGetFunc fn = rna_MEdge_bevel_weight_get;
    return fn(ptr);
}

void MeshEdge_bevel_weight_set(PointerRNA *ptr, float value)
{
    PropFloatSetFunc fn = rna_MEdge_bevel_weight_set;
    fn(ptr, value);
}
...
{
    PropFloatArraySetFunc fn = rna_MeshLoop_normal_set;
    fn(ptr, values);
}
...
{
    PropIntGetFunc fn = rna_MeshPolygon_loop_start_get;
    return fn(ptr);
}

void MeshPolygon_loop_start_set(PointerRNA *ptr, int value)
{
    PropIntSetFunc fn = rna_MeshPolygon_loop_start_set;
    fn(ptr, value);
}
...
int MeshUVLoopLayer_uv_lookup_int(PointerRNA *ptr, int index, PointerRNA *r_ptr)
{

    return rna_MeshUVLoopLayer_uv_lookup_int(ptr, index, r_ptr);
}

int MeshUVLoopLayer_vertex_selection_length(PointerRNA *ptr)
{
    return rna_MeshUVLoopLayer_data_length(ptr);
}
...
void MeshUVLoopLayer_vertex_selection_begin(CollectionPropertyIterator *iter, PointerRNA *ptr)
{
...
void MeshUVLoopLayer_vertex_selection_next(CollectionPropertyIterator *iter)
{
    rna_iterator_array_next(iter);
...
void MeshUVLoopLayer_vertex_selection_end(CollectionPropertyIterator *iter)
{
    rna_iterator_array_end(iter);
}

int MeshUVLoopLayer_vertex_selection_lookup_int(PointerRNA *ptr, int index, PointerRNA *r_ptr)
{

    return rna_MeshUVLoopLayer_vert_select_lookup_int(ptr, index, r_ptr);
}

int MeshUVLoopLayer_edge_selection_length(PointerRNA *ptr)
{
    return rna_MeshUVLoopLayer_data_length(ptr);
}
...
void MeshUVLoopLayer_edge_selection_begin(CollectionPropertyIterator *iter, PointerRNA *ptr)
{
...
void MeshUVLoopLayer_edge_selection_next(CollectionPropertyIterator *iter)
{
    rna_iterator_array_next(iter);
...
void MeshUVLoopLayer_edge_selection_end(CollectionPropertyIterator *iter)
{
    rna_iterator_array_end(iter);
}

int MeshUVLoopLayer_edge_selection_lookup_int(PointerRNA *ptr, int index, PointerRNA *r_ptr)
{
...
int MeshUVLoopLayer_pin_lookup_int(PointerRNA *ptr, int index, PointerRNA *r_ptr)
{
...
void rna_Mesh_calc_normals(struct Mesh *_self);
...
void MeshPolygon_flip_func(struct ID *_selfid, struct MIntProperty *_self)
{
...
CollectionPropertyRNA rna_Mesh_vertex_normals = {
	...
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	Mesh_vertex_normals_begin, Mesh_vertex_normals_next, Mesh_vertex_normals_end, Mesh_vertex_normals_get, Mesh_vertex_normals_length, Mesh_vertex_normals_lookup_int, NULL, NULL, &RNA_MeshNormalValue
};
...
CollectionPropertyRNA rna_Mesh_polygon_normals = {
	...
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	Mesh_polygon_normals_begin, Mesh_polygon_normals_next, Mesh_polygon_normals_end, Mesh_polygon_normals_get, Mesh_polygon_normals_length, Mesh_polygon_normals_lookup_int, NULL, NULL, &RNA_MeshNormalValue
};
...
CollectionPropertyRNA rna_Mesh_corner_normals = {
	...
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	Mesh_corner_normals_begin, Mesh_corner_normals_next, Mesh_corner_normals_end, Mesh_corner_normals_get, Mesh_corner_normals_length, Mesh_corner_normals_lookup_int, NULL, NULL, &RNA_MeshNormalValue
};
...
CollectionPropertyRNA rna_Mesh_loop_triangle_polygons = {
	...
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	Mesh_loop_triangle_polygons_begin, Mesh_loop_triangle_polygons_next, Mesh_loop_triangle_polygons_end, Mesh_loop_triangle_polygons_get, Mesh_loop_triangle_polygons_length, Mesh_loop_triangle_polygons_lookup_int, NULL, NULL, &RNA_ReadOnlyInteger
};
...
CollectionPropertyRNA rna_Mesh_vertex_creases = {
	{(PropertyRNA *)&rna_Mesh_edge_creases, (PropertyRNA *)&rna_Mesh_skin_vertices,
...
CollectionPropertyRNA rna_Mesh_edge_creases = {
	{(PropertyRNA *)&rna_Mesh_vertex_paint_masks, (PropertyRNA *)&rna_Mesh_vertex_creases,
	-1, "edge_creases", 0, 4, 0, 8, 0, "Edge Creases",
	"Sharpness of the edges for subdivision",
	0, "*",
	PROP_COLLECTION, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	Mesh_edge_creases_begin, Mesh_edge_creases_next, Mesh_edge_creases_end, Mesh_edge_creases_get, Mesh_edge_creases_length, Mesh_edge_creases_lookup_int, NULL, NULL, &RNA_MeshEdgeCreaseLayer
};

CollectionPropertyRNA rna_Mesh_vertex_paint_masks = {
	{(PropertyRNA *)&rna_Mesh_attributes, (PropertyRNA *)&rna_Mesh_edge_creases,
...
FloatPropertyRNA rna_Mesh_remesh_voxel_size = {
	...
	Mesh_remesh_voxel_size_get, Mesh_remesh_voxel_size_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0001000000f, FLT_MAX, 0.0001000000f, FLT_MAX, 0.0099999998f, 4, 0.1000000015f, NULL
};
...
FloatPropertyRNA rna_Mesh_remesh_voxel_adaptivity = {
	...
	Mesh_remesh_voxel_adaptivity_get, Mesh_remesh_voxel_adaptivity_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 1.0f, 0.0f, 1.0f, 0.0099999998f, 4, 0.0f, NULL
};
...
FloatPropertyRNA rna_Mesh_auto_smooth_angle = {
	...
	Mesh_auto_smooth_angle_get, Mesh_auto_smooth_angle_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 3.1415927410f, 0.0f, 3.1415927410f, 10.0f, 3, 0.5235987902f, NULL
};

BoolPropertyRNA rna_Mesh_has_custom_normals = {
	{(PropertyRNA *)&rna_Mesh_has_bevel_weight_edge, (PropertyRNA *)&rna_Mesh_auto_smooth_angle,
...
BoolPropertyRNA rna_Mesh_has_bevel_weight_edge = {
	{(PropertyRNA *)&rna_Mesh_has_bevel_weight_vertex, (PropertyRNA *)&rna_Mesh_has_custom_normals,
	-1, "has_bevel_weight_edge", 2, 0, 0, 0, 0, "Has Edge Bevel Weight",
	"True if the mesh has an edge bevel weight layer",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	Mesh_has_bevel_weight_edge_get, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};

BoolPropertyRNA rna_Mesh_has_bevel_weight_vertex = {
	{(PropertyRNA *)&rna_Mesh_has_crease_edge, (PropertyRNA *)&rna_Mesh_has_bevel_weight_edge,
	-1, "has_bevel_weight_vertex", 2, 0, 0, 0, 0, "Has Vertex Bevel Weight",
	"True if the mesh has an vertex bevel weight layer",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	Mesh_has_bevel_weight_vertex_get, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};

BoolPropertyRNA rna_Mesh_has_crease_edge = {
	{(PropertyRNA *)&rna_Mesh_has_crease_vertex, (PropertyRNA *)&rna_Mesh_has_bevel_weight_vertex,
	-1, "has_crease_edge", 2, 0, 0, 0, 0, "Has Edge Crease",
	"True if the mesh has an edge crease layer",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	Mesh_has_crease_edge_get, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};

BoolPropertyRNA rna_Mesh_has_crease_vertex = {
	{(PropertyRNA *)&rna_Mesh_texco_mesh, (PropertyRNA *)&rna_Mesh_has_crease_edge,
	-1, "has_crease_vertex", 2, 0, 0, 0, 0, "Has Vertex Crease",
	"True if the mesh has an vertex crease layer",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	Mesh_has_crease_vertex_get, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};

PointerPropertyRNA rna_Mesh_texco_mesh = {
	{(PropertyRNA *)&rna_Mesh_shape_keys, (PropertyRNA *)&rna_Mesh_has_crease_vertex,
...
FloatPropertyRNA rna_Mesh_texspace_location = {
	...
	0, -1, NULL},
	NULL, NULL, Mesh_texspace_location_get, Mesh_texspace_location_set, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, -10000.0f, 10000.0f, -FLT_MAX, FLT_MAX, 10.0f, 3, 0.0f, rna_Mesh_texspace_location_default
};
...
FloatPropertyRNA rna_Mesh_texspace_size = {
	...
	rna_Mesh_update_data_legacy_deg_tag_all, 0, rna_Mesh_texspace_editable, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	NULL, NULL, Mesh_texspace_size_get, Mesh_texspace_size_set, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, -10000.0f, 10000.0f, -FLT_MAX, FLT_MAX, 10.0f, 3, 0.0f, rna_Mesh_texspace_size_default
};
...
FloatPropertyRNA rna_Mesh_transform_matrix = {
	...
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 0.0f, -FLT_MAX, FLT_MAX, 1.0f, 3, 0.0f, rna_Mesh_transform_matrix_default
};
...
FunctionRNA rna_Mesh_calc_normals_func = {
	...
	NULL,
	{NULL, NULL}},
	"calc_normals", 0, "Deprecated. Has no effect. Normals are calculated upon retrieval",
...
FloatPropertyRNA rna_Mesh_normals_split_custom_set_normals = {
	...
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 0.0f, -1.0f, 1.0f, 1.0f, 3, 0.0f, rna_Mesh_normals_split_custom_set_normals_default
};
...
FloatPropertyRNA rna_Mesh_normals_split_custom_set_from_vertices_normals = {
	...
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 0.0f, -1.0f, 1.0f, 1.0f, 3, 0.0f, rna_Mesh_normals_split_custom_set_from_vertices_normals_default
};
...
FloatPropertyRNA rna_Mesh_unit_test_compare_threshold = {
	...
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, FLT_MAX, 0.0f, FLT_MAX, 1.0f, 3, 0.0000071526f, NULL
};
...
FloatPropertyRNA rna_MeshNormalValue_vector = {
	...
	NULL, NULL, MeshNormalValue_vector_get, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, -10000.0f, 10000.0f, -FLT_MAX, FLT_MAX, 10.0f, 3, 0.0f, rna_MeshNormalValue_vector_default
};
...
/* Read-only Integer */
CollectionPropertyRNA rna_ReadOnlyInteger_rna_properties = {
	{(PropertyRNA *)&rna_ReadOnlyInteger_rna_type, NULL,
	-1, "rna_properties", 0, 0, 0, 1, 0, "Properties",
	"RNA property collection",
	0, "*",
	PROP_COLLECTION, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	ReadOnlyInteger_rna_properties_begin, ReadOnlyInteger_rna_properties_next, ReadOnlyInteger_rna_properties_end, ReadOnlyInteger_rna_properties_get, NULL, NULL, ReadOnlyInteger_rna_properties_lookup_string, NULL, &RNA_Property
};
...
PointerPropertyRNA rna_ReadOnlyInteger_rna_type = {
	...
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	ReadOnlyInteger_rna_type_get, NULL, NULL, NULL,&RNA_Struct
};

IntPropertyRNA rna_ReadOnlyInteger_value = {
	{NULL, (PropertyRNA *)&rna_ReadOnlyInteger_rna_type,
	...
	ReadOnlyInteger_value_get, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL,
	0, -10000, 10000, INT_MIN, INT_MAX, 1, 0, NULL
};
...
StructRNA RNA_ReadOnlyInteger = {
	...
	"ReadOnlyInteger", NULL, NULL, 516, NULL, "Read-only Integer",
	"",
	"*", 17,
	NULL, (PropertyRNA *)&rna_ReadOnlyInteger_rna_properties,
	NULL,
	NULL,
	NULL,
	NULL,
...
FloatPropertyRNA rna_MeshSkinVertex_radius = {
	...
	NULL, NULL, MeshSkinVertex_radius_get, MeshSkinVertex_radius_set, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0010000000f, 100.0f, 0.0f, FLT_MAX, 1.0f, 3, 0.0f, rna_MeshSkinVertex_radius_default
};
...
FloatPropertyRNA rna_MeshVertexCrease_value = {
	...
	MeshVertexCrease_value_get, MeshVertexCrease_value_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, -10000.0f, 10000.0f, -FLT_MAX, FLT_MAX, 10.0f, 3, 0.0f, NULL
};

StructRNA RNA_MeshVertexCrease = {
	{(ContainerRNA *)&RNA_MeshEdgeCreaseLayer, (ContainerRNA *)&RNA_MeshVertexCreaseLayer,
	NULL,
...
/* Mesh Edge Crease Layer */
CollectionPropertyRNA rna_MeshEdgeCreaseLayer_rna_properties = {
	{(PropertyRNA *)&rna_MeshEdgeCreaseLayer_rna_type, NULL,
	-1, "rna_properties", 0, 0, 0, 1, 0, "Properties",
	"RNA property collection",
	0, "*",
	PROP_COLLECTION, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	MeshEdgeCreaseLayer_rna_properties_begin, MeshEdgeCreaseLayer_rna_properties_next, MeshEdgeCreaseLayer_rna_properties_end, MeshEdgeCreaseLayer_rna_properties_get, NULL, NULL, MeshEdgeCreaseLayer_rna_properties_lookup_string, NULL, &RNA_Property
};

PointerPropertyRNA rna_MeshEdgeCreaseLayer_rna_type = {
	{(PropertyRNA *)&rna_MeshEdgeCreaseLayer_data, (PropertyRNA *)&rna_MeshEdgeCreaseLayer_rna_properties,
	-1, "rna_type", 8912896, 0, 0, 0, 0, "RNA",
	"RNA type definition",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	MeshEdgeCreaseLayer_rna_type_get, NULL, NULL, NULL,&RNA_Struct
};

CollectionPropertyRNA rna_MeshEdgeCreaseLayer_data = {
	{NULL, (PropertyRNA *)&rna_MeshEdgeCreaseLayer_rna_type,
	-1, "data", 0, 4, 0, 8, 0, "Data",
	"",
	0, "*",
	PROP_COLLECTION, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	MeshEdgeCreaseLayer_data_begin, MeshEdgeCreaseLayer_data_next, MeshEdgeCreaseLayer_data_end, MeshEdgeCreaseLayer_data_get, MeshEdgeCreaseLayer_data_length, MeshEdgeCreaseLayer_data_lookup_int, NULL, NULL, &RNA_MeshEdgeCrease
};

StructRNA RNA_MeshEdgeCreaseLayer = {
	{(ContainerRNA *)&RNA_MeshEdgeCrease, (ContainerRNA *)&RNA_MeshVertexCrease,
	NULL,
	{(PropertyRNA *)&rna_MeshEdgeCreaseLayer_rna_properties, (PropertyRNA *)&rna_MeshEdgeCreaseLayer_data}},
	"MeshEdgeCreaseLayer", NULL, NULL, 516, NULL, "Mesh Edge Crease Layer",
	"Per-edge crease",
	"*", 17,
	NULL, (PropertyRNA *)&rna_MeshEdgeCreaseLayer_rna_properties,
	NULL,
	NULL,
	NULL,
	rna_MeshEdgeCreaseLayer_path,
	NULL,
	NULL,
	NULL,
	NULL,
...
/* Float Property */
CollectionPropertyRNA rna_MeshEdgeCrease_rna_properties = {
	{(PropertyRNA *)&rna_MeshEdgeCrease_rna_type, NULL,
	-1, "rna_properties", 0, 0, 0, 1, 0, "Properties",
	"RNA property collection",
	0, "*",
	PROP_COLLECTION, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	MeshEdgeCrease_rna_properties_begin, MeshEdgeCrease_rna_properties_next, MeshEdgeCrease_rna_properties_end, MeshEdgeCrease_rna_properties_get, NULL, NULL, MeshEdgeCrease_rna_properties_lookup_string, NULL, &RNA_Property
};

PointerPropertyRNA rna_MeshEdgeCrease_rna_type = {
	{(PropertyRNA *)&rna_MeshEdgeCrease_value, (PropertyRNA *)&rna_MeshEdgeCrease_rna_properties,
	-1, "rna_type", 8912896, 0, 0, 0, 0, "RNA",
	"RNA type definition",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	MeshEdgeCrease_rna_type_get, NULL, NULL, NULL,&RNA_Struct
};

FloatPropertyRNA rna_MeshEdgeCrease_value = {
	{NULL, (PropertyRNA *)&rna_MeshEdgeCrease_rna_type,
	-1, "value", 3, 0, 0, 4, 0, "Value",
	"",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Mesh_update_data_legacy_deg_tag_all, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	offsetof(MFloatProperty, f), 5, NULL},
	MeshEdgeCrease_value_get, MeshEdgeCrease_value_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, -10000.0f, 10000.0f, -FLT_MAX, FLT_MAX, 10.0f, 3, 0.0f, NULL
};

StructRNA RNA_MeshEdgeCrease = {
	{(ContainerRNA *)&RNA_MeshPaintMaskLayer, (ContainerRNA *)&RNA_MeshEdgeCreaseLayer,
	NULL,
	{(PropertyRNA *)&rna_MeshEdgeCrease_rna_properties, (PropertyRNA *)&rna_MeshEdgeCrease_value}},
	"MeshEdgeCrease", NULL, NULL, 516, NULL, "Float Property",
	"",
	"*", 17,
	NULL, (PropertyRNA *)&rna_MeshEdgeCrease_rna_properties,
	NULL,
	NULL,
	NULL,
	NULL,
...
StructRNA RNA_MeshPaintMaskLayer = {
	{(ContainerRNA *)&RNA_MeshPaintMaskProperty, (ContainerRNA *)&RNA_MeshEdgeCrease,
	NULL,
...
FloatPropertyRNA rna_MeshPaintMaskProperty_value = {
	...
	rna_Mesh_update_data_legacy_deg_tag_all, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	offsetof(MFloatProperty, f), 5, NULL},
	MeshPaintMaskProperty_value_get, MeshPaintMaskProperty_value_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, -10000.0f, 10000.0f, -FLT_MAX, FLT_MAX, 10.0f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_MeshVertex_co = {
	...
	0, -1, NULL},
	NULL, NULL, MeshVertex_co_get, MeshVertex_co_set, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, -10000.0f, 10000.0f, -FLT_MAX, FLT_MAX, 10.0f, 3, 0.0f, rna_MeshVertex_co_default
};
...
FloatPropertyRNA rna_MeshVertex_normal = {
	...
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	NULL, NULL, MeshVertex_normal_get, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, -10000.0f, 10000.0f, -FLT_MAX, FLT_MAX, 10.0f, 3, 0.0f, rna_MeshVertex_normal_default
};
...
FloatPropertyRNA rna_MeshVertex_bevel_weight = {
	...
	rna_Mesh_update_data_legacy_deg_tag_all, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	MeshVertex_bevel_weight_get, MeshVertex_bevel_weight_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, -10000.0f, 10000.0f, -FLT_MAX, FLT_MAX, 10.0f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_MeshVertex_undeformed_co = {
	...
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	NULL, NULL, MeshVertex_undeformed_co_get, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, -10000.0f, 10000.0f, -FLT_MAX, FLT_MAX, 10.0f, 3, 0.0f, rna_MeshVertex_undeformed_co_default
};
...
FloatPropertyRNA rna_VertexGroupElement_weight = {
	...
	VertexGroupElement_weight_get, VertexGroupElement_weight_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 1.0f, 0.0f, 1.0f, 10.0f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_MeshEdge_crease = {
	...
	rna_Mesh_update_data_legacy_deg_tag_all, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	MeshEdge_crease_get, MeshEdge_crease_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, -10000.0f, 10000.0f, -FLT_MAX, FLT_MAX, 10.0f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_MeshEdge_bevel_weight = {
	...
	rna_Mesh_update_data_legacy_deg_tag_all, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	MeshEdge_bevel_weight_get, MeshEdge_bevel_weight_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, -10000.0f, 10000.0f, -FLT_MAX, FLT_MAX, 10.0f, 3, 0.0f, NULL
};
...
BoolPropertyRNA rna_MeshEdge_is_loose = {
	...
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	MeshEdge_is_loose_get, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};
...
FloatPropertyRNA rna_MeshLoopTriangle_normal = {
	...
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	NULL, NULL, MeshLoopTriangle_normal_get, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, -1.0f, 1.0f, -1.0f, 1.0f, 10.0f, 3, 0.0f, rna_MeshLoopTriangle_normal_default
};
...
FloatPropertyRNA rna_MeshLoopTriangle_split_normals = {
	...
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	NULL, NULL, MeshLoopTriangle_split_normals_get, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, -1.0f, 1.0f, -1.0f, 1.0f, 10.0f, 3, 0.0f, rna_MeshLoopTriangle_split_normals_default
};
...
FloatPropertyRNA rna_MeshLoopTriangle_area = {
	...
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	MeshLoopTriangle_area_get, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 10000.0f, 0.0f, FLT_MAX, 10.0f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_MeshLoop_normal = {
	...
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	NULL, NULL, MeshLoop_normal_get, MeshLoop_normal_set, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, -1.0f, 1.0f, -1.0f, 1.0f, 10.0f, 3, 0.0f, rna_MeshLoop_normal_default
};
...
FloatPropertyRNA rna_MeshLoop_tangent = {
	...
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	NULL, NULL, MeshLoop_tangent_get, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, -1.0f, 1.0f, -1.0f, 1.0f, 10.0f, 3, 0.0f, rna_MeshLoop_tangent_default
};
...
FloatPropertyRNA rna_MeshLoop_bitangent_sign = {
	...
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	MeshLoop_bitangent_sign_get, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, -1.0f, 1.0f, -1.0f, 1.0f, 10.0f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_MeshLoop_bitangent = {
	...
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	NULL, NULL, MeshLoop_bitangent_get, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, -1.0f, 1.0f, -1.0f, 1.0f, 10.0f, 3, 0.0f, rna_MeshLoop_bitangent_default
};
...
IntPropertyRNA rna_MeshPolygon_loop_start = {
	...
	-1, "loop_start", 3, 0, 0, 0, 0, "Loop Start",
...
IntPropertyRNA rna_MeshPolygon_loop_total = {
	...
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	MeshPolygon_loop_total_get, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL,
	0, 0, 10000, 0, INT_MAX, 1, 0, NULL
};
...
FloatPropertyRNA rna_MeshPolygon_normal = {
	...
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	NULL, NULL, MeshPolygon_normal_get, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, -1.0f, 1.0f, -1.0f, 1.0f, 10.0f, 3, 0.0f, rna_MeshPolygon_normal_default
};
...
FloatPropertyRNA rna_MeshPolygon_center = {
	...
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	NULL, NULL, MeshPolygon_center_get, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, -10000.0f, 10000.0f, -FLT_MAX, FLT_MAX, 10.0f, 3, 0.0f, rna_MeshPolygon_center_default
};
...
FloatPropertyRNA rna_MeshPolygon_area = {
	...
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	MeshPolygon_area_get, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 10000.0f, 0.0f, FLT_MAX, 10.0f, 3, 0.0f, NULL
};
...
CollectionPropertyRNA rna_MeshUVLoopLayer_uv = {
	...
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	MeshUVLoopLayer_uv_begin, MeshUVLoopLayer_uv_next, MeshUVLoopLayer_uv_end, MeshUVLoopLayer_uv_get, MeshUVLoopLayer_uv_length, MeshUVLoopLayer_uv_lookup_int, NULL, NULL, &RNA_Float2AttributeValue
};
...
CollectionPropertyRNA rna_MeshUVLoopLayer_vertex_selection = {
	...
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	MeshUVLoopLayer_vertex_selection_begin, MeshUVLoopLayer_vertex_selection_next, MeshUVLoopLayer_vertex_selection_end, MeshUVLoopLayer_vertex_selection_get, MeshUVLoopLayer_vertex_selection_length, MeshUVLoopLayer_vertex_selection_lookup_int, NULL, NULL, &RNA_BoolAttributeValue
};
...
CollectionPropertyRNA rna_MeshUVLoopLayer_edge_selection = {
	...
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	MeshUVLoopLayer_edge_selection_begin, MeshUVLoopLayer_edge_selection_next, MeshUVLoopLayer_edge_selection_end, MeshUVLoopLayer_edge_selection_get, MeshUVLoopLayer_edge_selection_length, MeshUVLoopLayer_edge_selection_lookup_int, NULL, NULL, &RNA_BoolAttributeValue
};

CollectionPropertyRNA rna_MeshUVLoopLayer_pin = {
	{NULL, (PropertyRNA *)&rna_MeshUVLoopLayer_edge_selection,
	...
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	MeshUVLoopLayer_pin_begin, MeshUVLoopLayer_pin_next, MeshUVLoopLayer_pin_end, MeshUVLoopLayer_pin_get, MeshUVLoopLayer_pin_length, MeshUVLoopLayer_pin_lookup_int, NULL, NULL, &RNA_BoolAttributeValue
};
...
FloatPropertyRNA rna_MeshUVLoop_uv = {
	...
	rna_Mesh_update_data_legacy_deg_tag_all, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	NULL, NULL, MeshUVLoop_uv_get, MeshUVLoop_uv_set, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, -10000.0f, 10000.0f, -FLT_MAX, FLT_MAX, 10.0f, 3, 0.0f, rna_MeshUVLoop_uv_default
};
...
StructRNA RNA_MeshUVLoop = {
	...
	"MeshUVLoop", NULL, NULL, 516, NULL, "Mesh UV Layer",
...
FloatPropertyRNA rna_MeshLoopColor_color = {
	...
	rna_Mesh_update_data_legacy_deg_tag_all, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	NULL, NULL, MeshLoopColor_color_get, MeshLoopColor_color_set, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 1.0f, 0.0f, 1.0f, 10.0f, 3, 0.0f, rna_MeshLoopColor_color_default
};
...
FloatPropertyRNA rna_MeshVertColor_color = {
	...
	NULL, NULL, MeshVertColor_color_get, MeshVertColor_color_set, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 1.0f, 0.0f, 1.0f, 10.0f, 3, 0.0f, rna_MeshVertColor_color_default
};
...
FloatPropertyRNA rna_MeshVertexFloatProperty_value = {
	...
	rna_Mesh_update_data_legacy_deg_tag_all, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	offsetof(MFloatProperty, f), 5, NULL},
	MeshVertexFloatProperty_value_get, MeshVertexFloatProperty_value_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, -10000.0f, 10000.0f, -FLT_MAX, FLT_MAX, 10.0f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_MeshPolygonFloatProperty_value = {
	...
	rna_Mesh_update_data_legacy_deg_tag_all, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	offsetof(MFloatProperty, f), 5, NULL},
	MeshPolygonFloatProperty_value_get, MeshPolygonFloatProperty_value_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, -10000.0f, 10000.0f, -FLT_MAX, FLT_MAX, 10.0f, 3, 0.0f, NULL
};

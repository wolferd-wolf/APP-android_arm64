...
bool Sculpt_use_automasking_cavity_get(PointerRNA *ptr)
{
    Sculpt *data = (Sculpt *)(ptr->data);
    return (((data->automasking_flags) & 16) != 0);
}

void Sculpt_use_automasking_cavity_set(PointerRNA *ptr, bool value)
{
    PropBooleanSetFunc fn = rna_Sculpt_automasking_cavity_set;
    fn(ptr, value);
}

bool Sculpt_use_automasking_cavity_inverted_get(PointerRNA *ptr)
{
    Sculpt *data = (Sculpt *)(ptr->data);
    return (((data->automasking_flags) & 32) != 0);
}

void Sculpt_use_automasking_cavity_inverted_set(PointerRNA *ptr, bool value)
{
    PropBooleanSetFunc fn = rna_Sculpt_automasking_invert_cavity_set;
    fn(ptr, value);
}

bool Sculpt_use_automasking_custom_cavity_curve_get(PointerRNA *ptr)
{
    Sculpt *data = (Sculpt *)(ptr->data);
    return (((data->automasking_flags) & 64) != 0);
}

void Sculpt_use_automasking_custom_cavity_curve_set(PointerRNA *ptr, bool value)
{
    Sculpt *data = (Sculpt *)(ptr->data);
...
float Sculpt_automasking_cavity_factor_get(PointerRNA *ptr)
{
    Sculpt *data = (Sculpt *)(ptr->data);
    return (float)(data->automasking_cavity_factor);
}

void Sculpt_automasking_cavity_factor_set(PointerRNA *ptr, float value)
{
    Sculpt *data = (Sculpt *)(ptr->data);
    data->automasking_cavity_factor = CLAMPIS(value, 0.0f, 5.0f);
}

int Sculpt_automasking_cavity_blur_steps_get(PointerRNA *ptr)
{
    Sculpt *data = (Sculpt *)(ptr->data);
    return (int)(data->automasking_cavity_blur_steps);
}

void Sculpt_automasking_cavity_blur_steps_set(PointerRNA *ptr, int value)
{
    Sculpt *data = (Sculpt *)(ptr->data);
...
PointerRNA Sculpt_automasking_cavity_curve_get(PointerRNA *ptr)
{
    Sculpt *data = (Sculpt *)(ptr->data);
    return rna_pointer_inherit_refine(ptr, &RNA_CurveMapping, data->automasking_cavity_curve);
}

PointerRNA Sculpt_automasking_cavity_curve_op_get(PointerRNA *ptr)
{
    Sculpt *data = (Sculpt *)(ptr->data);
    return rna_pointer_inherit_refine(ptr, &RNA_CurveMapping, data->automasking_cavity_curve_op);
}

bool Sculpt_use_automasking_start_normal_get(PointerRNA *ptr)
{
    Sculpt *data = (Sculpt *)(ptr->data);
    return (((data->automasking_flags) & 256) != 0);
}

void Sculpt_use_automasking_start_normal_set(PointerRNA *ptr, bool value)
{
    Sculpt *data = (Sculpt *)(ptr->data);
...
bool Sculpt_use_automasking_view_normal_get(PointerRNA *ptr)
{
    Sculpt *data = (Sculpt *)(ptr->data);
    return (((data->automasking_flags) & 512) != 0);
}

void Sculpt_use_automasking_view_normal_set(PointerRNA *ptr, bool value)
{
    Sculpt *data = (Sculpt *)(ptr->data);
...
bool Sculpt_use_automasking_view_occlusion_get(PointerRNA *ptr)
{
    Sculpt *data = (Sculpt *)(ptr->data);
    return (((data->automasking_flags) & 1024) != 0);
}

void Sculpt_use_automasking_view_occlusion_set(PointerRNA *ptr, bool value)
{
    Sculpt *data = (Sculpt *)(ptr->data);
...
float Sculpt_automasking_start_normal_limit_get(PointerRNA *ptr)
{
    Sculpt *data = (Sculpt *)(ptr->data);
    return (float)(data->automasking_start_normal_limit);
}

void Sculpt_automasking_start_normal_limit_set(PointerRNA *ptr, float value)
{
    Sculpt *data = (Sculpt *)(ptr->data);
    data->automasking_start_normal_limit = CLAMPIS(value, 0.0001000000f, 3.1415927410f);
}

float Sculpt_automasking_start_normal_falloff_get(PointerRNA *ptr)
{
    Sculpt *data = (Sculpt *)(ptr->data);
    return (float)(data->automasking_start_normal_falloff);
}

void Sculpt_automasking_start_normal_falloff_set(PointerRNA *ptr, float value)
{
    Sculpt *data = (Sculpt *)(ptr->data);
    data->automasking_start_normal_falloff = CLAMPIS(value, 0.0001000000f, 1.0f);
}

float Sculpt_automasking_view_normal_limit_get(PointerRNA *ptr)
{
    Sculpt *data = (Sculpt *)(ptr->data);
    return (float)(data->automasking_view_normal_limit);
}

void Sculpt_automasking_view_normal_limit_set(PointerRNA *ptr, float value)
{
    Sculpt *data = (Sculpt *)(ptr->data);
    data->automasking_view_normal_limit = CLAMPIS(value, 0.0001000000f, 3.1415927410f);
}

float Sculpt_automasking_view_normal_falloff_get(PointerRNA *ptr)
{
    Sculpt *data = (Sculpt *)(ptr->data);
    return (float)(data->automasking_view_normal_falloff);
}

void Sculpt_automasking_view_normal_falloff_set(PointerRNA *ptr, float value)
{
    Sculpt *data = (Sculpt *)(ptr->data);
...
FloatPropertyRNA rna_Paint_tile_offset = {
	...
	NULL, NULL, Paint_tile_offset_get, Paint_tile_offset_set, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0099999998f, 100.0f, 0.0099999998f, FLT_MAX, 100.0f, 2, 0.0f, rna_Paint_tile_offset_default
};
...
FloatPropertyRNA rna_Sculpt_detail_size = {
	...
	Sculpt_detail_size_get, Sculpt_detail_size_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_CUBIC, 0.5000000000f, 40.0f, -FLT_MAX, FLT_MAX, 0.1000000015f, 2, 0.0f, NULL
};
...
FloatPropertyRNA rna_Sculpt_detail_percent = {
	...
	Sculpt_detail_percent_get, Sculpt_detail_percent_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.5000000000f, 100.0f, -FLT_MAX, FLT_MAX, 10.0f, 2, 0.0f, NULL
};
...
FloatPropertyRNA rna_Sculpt_constant_detail_resolution = {
	...
	Sculpt_constant_detail_resolution_get, Sculpt_constant_detail_resolution_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0010000000f, 1000.0f, 0.0001000000f, FLT_MAX, 10.0f, 2, 0.0f, NULL
};
...
BoolPropertyRNA rna_Sculpt_use_automasking_cavity = {
	...
	NULL, 84869120, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	Sculpt_use_automasking_cavity_get, Sculpt_use_automasking_cavity_set, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};
...
BoolPropertyRNA rna_Sculpt_use_automasking_cavity_inverted = {
	...
	NULL, 84869120, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	Sculpt_use_automasking_cavity_inverted_get, Sculpt_use_automasking_cavity_inverted_set, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};
...
BoolPropertyRNA rna_Sculpt_use_automasking_custom_cavity_curve = {
	...
	NULL, 84869120, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	Sculpt_use_automasking_custom_cavity_curve_get, Sculpt_use_automasking_custom_cavity_curve_set, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};
...
FloatPropertyRNA rna_Sculpt_automasking_cavity_factor = {
	...
	NULL, 84869120, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	offsetof(Sculpt, automasking_cavity_factor), 5, NULL},
	Sculpt_automasking_cavity_factor_get, Sculpt_automasking_cavity_factor_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 1.0f, 0.0f, 5.0f, 0.1000000015f, 3, 1.0f, NULL
};
...
IntPropertyRNA rna_Sculpt_automasking_cavity_blur_steps = {
	...
	NULL, 84869120, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	offsetof(Sculpt, automasking_cavity_blur_steps), 0, NULL},
	Sculpt_automasking_cavity_blur_steps_get, Sculpt_automasking_cavity_blur_steps_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL,
...
PointerPropertyRNA rna_Sculpt_automasking_cavity_curve = {
	...
	NULL, 84869120, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	Sculpt_automasking_cavity_curve_get, NULL, NULL, NULL,&RNA_CurveMapping
};
...
PointerPropertyRNA rna_Sculpt_automasking_cavity_curve_op = {
	...
	NULL, 84869120, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	Sculpt_automasking_cavity_curve_op_get, NULL, NULL, NULL,&RNA_CurveMapping
};
...
BoolPropertyRNA rna_Sculpt_use_automasking_start_normal = {
	...
	NULL, 84869120, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	Sculpt_use_automasking_start_normal_get, Sculpt_use_automasking_start_normal_set, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};
...
BoolPropertyRNA rna_Sculpt_use_automasking_view_normal = {
	...
	NULL, 84869120, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	Sculpt_use_automasking_view_normal_get, Sculpt_use_automasking_view_normal_set, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};
...
BoolPropertyRNA rna_Sculpt_use_automasking_view_occlusion = {
	...
	NULL, 84869120, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	Sculpt_use_automasking_view_occlusion_get, Sculpt_use_automasking_view_occlusion_set, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};
...
FloatPropertyRNA rna_Sculpt_automasking_start_normal_limit = {
	...
	NULL, 84869120, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	offsetof(Sculpt, automasking_start_normal_limit), 5, NULL},
	Sculpt_automasking_start_normal_limit_get, Sculpt_automasking_start_normal_limit_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0001000000f, 3.1415927410f, 0.0001000000f, 3.1415927410f, 10.0f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_Sculpt_automasking_start_normal_falloff = {
	...
	PROP_FLOAT, PROP_FACTOR | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 84869120, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	offsetof(Sculpt, automasking_start_normal_falloff), 5, NULL},
	Sculpt_automasking_start_normal_falloff_get, Sculpt_automasking_start_normal_falloff_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0001000000f, 1.0f, 0.0001000000f, 1.0f, 10.0f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_Sculpt_automasking_view_normal_limit = {
	...
	PROP_FLOAT, PROP_ANGLE | PROP_UNIT_ROTATION, NULL, 0, {0, 0, 0}, 0,
	NULL, 84869120, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	offsetof(Sculpt, automasking_view_normal_limit), 5, NULL},
	Sculpt_automasking_view_normal_limit_get, Sculpt_automasking_view_normal_limit_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0001000000f, 3.1415927410f, 0.0001000000f, 3.1415927410f, 10.0f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_Sculpt_automasking_view_normal_falloff = {
	...
	PROP_FLOAT, PROP_FACTOR | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 84869120, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	offsetof(Sculpt, automasking_view_normal_falloff), 5, NULL},
	Sculpt_automasking_view_normal_falloff_get, Sculpt_automasking_view_normal_falloff_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0001000000f, 1.0f, 0.0001000000f, 1.0f, 10.0f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_Sculpt_gravity = {
	...
	Sculpt_gravity_get, Sculpt_gravity_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 1.0f, 0.0f, 1.0f, 0.1000000015f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_ImagePaint_stencil_color = {
	...
	NULL, NULL, ImagePaint_stencil_color_get, ImagePaint_stencil_color_set, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 1.0f, 0.0f, 1.0f, 10.0f, 3, 0.0f, rna_ImagePaint_stencil_color_default
};
...
FloatPropertyRNA rna_ImagePaint_dither = {
	...
	ImagePaint_dither_get, ImagePaint_dither_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 2.0f, 0.0f, 2.0f, 10.0f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_ParticleEdit_emitter_distance = {
	...
	ParticleEdit_emitter_distance_get, ParticleEdit_emitter_distance_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 10.0f, -FLT_MAX, FLT_MAX, 10.0f, 3, 0.2500000000f, NULL
};
...
FloatPropertyRNA rna_ParticleBrush_strength = {
	...
	ParticleBrush_strength_get, ParticleBrush_strength_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0010000000f, 1.0f, 0.0010000000f, 1.0f, 10.0f, 3, 0.5000000000f, NULL
};
...
FloatPropertyRNA rna_GPencilSculptGuide_angle = {
	...
	GPencilSculptGuide_angle_get, GPencilSculptGuide_angle_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, -6.2831854820f, 6.2831854820f, -6.2831854820f, 6.2831854820f, 10.0f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_GPencilSculptGuide_angle_snap = {
	...
	GPencilSculptGuide_angle_snap_get, GPencilSculptGuide_angle_snap_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, -6.2831854820f, 6.2831854820f, -6.2831854820f, 6.2831854820f, 10.0f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_GPencilSculptGuide_spacing = {
	...
	GPencilSculptGuide_spacing_get, GPencilSculptGuide_spacing_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, FLT_MAX, 0.0f, FLT_MAX, 1.0f, 3, 20.0f, NULL
};
...
FloatPropertyRNA rna_GPencilSculptGuide_location = {
	...
	NULL, NULL, GPencilSculptGuide_location_get, GPencilSculptGuide_location_set, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, -FLT_MAX, FLT_MAX, -FLT_MAX, FLT_MAX, 1.0f, 3, 0.0f, rna_GPencilSculptGuide_location_default
};
...
BoolPropertyRNA rna_GPencilSculptSettings_use_automasking_stroke = {
	...
	NULL, 84869120, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	GPencilSculptSettings_use_automasking_stroke_get, GPencilSculptSettings_use_automasking_stroke_set, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};
...
BoolPropertyRNA rna_GPencilSculptSettings_use_automasking_layer_stroke = {
	...
	NULL, 84869120, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	GPencilSculptSettings_use_automasking_layer_stroke_get, GPencilSculptSettings_use_automasking_layer_stroke_set, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};
...
BoolPropertyRNA rna_GPencilSculptSettings_use_automasking_material_stroke = {
	...
	NULL, 84869120, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	GPencilSculptSettings_use_automasking_material_stroke_get, GPencilSculptSettings_use_automasking_material_stroke_set, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};
...
BoolPropertyRNA rna_GPencilSculptSettings_use_automasking_layer_active = {
	...
	NULL, 84869120, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	GPencilSculptSettings_use_automasking_layer_active_get, GPencilSculptSettings_use_automasking_layer_active_set, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};
...
BoolPropertyRNA rna_GPencilSculptSettings_use_automasking_material_active = {
	...
	NULL, 84869120, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	GPencilSculptSettings_use_automasking_material_active_get, GPencilSculptSettings_use_automasking_material_active_set, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};
...
FloatPropertyRNA rna_GPencilSculptSettings_intersection_threshold = {
	...
	GPencilSculptSettings_intersection_threshold_get, GPencilSculptSettings_intersection_threshold_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 10.0f, 0.0f, 10.0f, 10.0f, 3, 0.1000000015f, NULL
};

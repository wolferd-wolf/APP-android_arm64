...
extern BoolPropertyRNA rna_UILayout_template_image_settings_show_z_buffer;
...
void Panel_bl_order_set(PointerRNA *ptr, int value)
{
    ...
    { BLI_STATIC_ASSERT((TYPEOF_MAX(data->type->order) >= 2147483647) && (TYPEOF_MIN(data->type->order) <= 0), "invalid limits"); }
}
...
{
    uiList *data = (uiList *)(ptr->data);
    return (((data->filter_sort_flag) & 2147483648LL) != 0);
}

void UIList_use_filter_sort_reverse_set(PointerRNA *ptr, bool value)
{
    uiList *data = (uiList *)(ptr->data);
    if (value) { data->filter_sort_flag |= 2147483648LL; }
    else { data->filter_sort_flag &= ~2147483648LL; }
}
...
void UILayout_template_image_settings_func(struct uiLayout *_self, struct PointerRNA *image_settings, bool color_management, bool show_z_buffer)
{
	uiTemplateImageSettings(_self, image_settings, color_management, show_z_buffer);
}
...
void UILayout_template_status_info_func(struct uiLayout *_self, bContext *C)
{
	uiTemplateStatusInfo(_self, C);
}

void UILayout_template_status_info_call(bContext *C, ReportList *reports, PointerRNA *_ptr, ParameterList *_parms)
{
	struct uiLayout *_self;
	_self = (struct uiLayout *)_ptr->data;
...
void UILayout_template_node_asset_menu_items_func(struct uiLayout *_self, bContext *C, const char * catalog_path)
{
	uiTemplateNodeAssetMenuItems(_self, C, catalog_path);
}

void UILayout_template_node_asset_menu_items_call(bContext *C, ReportList *reports, PointerRNA *_ptr, ParameterList *_parms)
{
	struct uiLayout *_self;
...
void uiTemplateImageSettings(struct uiLayout *_self, struct PointerRNA *image_settings, bool color_management, bool show_z_buffer);
...
void uiTemplateNodeAssetMenuItems(struct uiLayout *_self, bContext *C, const char * catalog_path);
...
FloatPropertyRNA rna_UILayout_scale_x = {
	...
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	UILayout_scale_x_get, UILayout_scale_x_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 10000.0f, 0.0f, FLT_MAX, 10.0f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_UILayout_scale_y = {
	...
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	UILayout_scale_y_get, UILayout_scale_y_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 10000.0f, 0.0f, FLT_MAX, 10.0f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_UILayout_ui_units_x = {
	...
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	UILayout_ui_units_x_get, UILayout_ui_units_x_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 10000.0f, 0.0f, FLT_MAX, 10.0f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_UILayout_ui_units_y = {
	...
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	UILayout_ui_units_y_get, UILayout_ui_units_y_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 10000.0f, 0.0f, FLT_MAX, 10.0f, 3, 0.0f, NULL
};
...
EnumPropertyRNA rna_UILayout_prop_icon = {
	...
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	NULL, NULL, NULL, NULL, NULL, rna_enum_icon_items, 836, 0
};
...
FloatPropertyRNA rna_UILayout_template_greasepencil_color_scale = {
	...
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.5000000000f, 1.0f, 0.1000000015f, 1.5000000000f, 1.0f, 3, 1.0f, NULL
};
...
FloatPropertyRNA rna_UILayout_template_icon_scale = {
	...
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 1.0f, 100.0f, 1.0f, 100.0f, 1.0f, 3, 1.0f, NULL
};
...
FloatPropertyRNA rna_UILayout_template_icon_view_scale = {
	...
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 1.0f, 100.0f, 1.0f, 100.0f, 1.0f, 3, 6.0f, NULL
};
...
FloatPropertyRNA rna_UILayout_template_icon_view_scale_popup = {
	...
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 1.0f, 100.0f, 1.0f, 100.0f, 1.0f, 3, 5.0f, NULL
};
...
BoolPropertyRNA rna_UILayout_template_image_settings_color_management = {
	{(PropertyRNA *)&rna_UILayout_template_image_settings_show_z_buffer, (PropertyRNA *)&rna_UILayout_template_image_settings_image_settings,
...
BoolPropertyRNA rna_UILayout_template_image_settings_show_z_buffer = {
	{NULL, (PropertyRNA *)&rna_UILayout_template_image_settings_color_management,
	-1, "show_z_buffer", 3, 0, 0, 0, 0, "",
	"Show option to save z-buffer",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
...
FunctionRNA rna_UILayout_template_image_settings_func = {
	...
	NULL,
	{(PropertyRNA *)&rna_UILayout_template_image_settings_image_settings, (PropertyRNA *)&rna_UILayout_template_image_settings_show_z_buffer}},
...
FunctionRNA rna_UILayout_template_node_asset_menu_items_func = {
	{(FunctionRNA *)&rna_UILayout_template_texture_user_func, (FunctionRNA *)&rna_UILayout_template_node_view_func,
	NULL,
...
FunctionRNA rna_UILayout_template_texture_user_func = {
	{(FunctionRNA *)&rna_UILayout_template_keymap_item_properties_func, (FunctionRNA *)&rna_UILayout_template_node_asset_menu_items_func,
	NULL,
	{NULL, NULL}},
...
FloatPropertyRNA rna_UILayout_template_node_socket_color = {
	...
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 1.0f, 0.0f, 1.0f, 1.0f, 3, 0.0f, rna_UILayout_template_node_socket_color_default
};
...
StringPropertyRNA rna_Panel_bl_description = {
	...
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	Panel_bl_description_get, Panel_bl_description_length, Panel_bl_description_set, NULL, NULL, NULL, NULL, 0, 1024, ""
};
...
StringPropertyRNA rna_Menu_bl_description = {
	...
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	Menu_bl_description_get, Menu_bl_description_length, Menu_bl_description_set, NULL, NULL, NULL, NULL, 0, 1024, ""
};

...
void CacheFile_prefetch_cache_size_set(PointerRNA *ptr, int value)
{
    ...
    { BLI_STATIC_ASSERT((TYPEOF_MAX(data->prefetch_cache_size) >= 2147483647) && (TYPEOF_MIN(data->prefetch_cache_size) <= 0), "invalid limits"); }
}
...
FloatPropertyRNA rna_CacheFile_frame = {
	...
	CacheFile_frame_get, CacheFile_frame_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, -1048574.0f, 1048574.0f, -1048574.0f, 1048574.0f, 10.0f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_CacheFile_frame_offset = {
	...
	CacheFile_frame_offset_get, CacheFile_frame_offset_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, -1048574.0f, 1048574.0f, -1048574.0f, 1048574.0f, 10.0f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_CacheFile_scale = {
	...
	CacheFile_scale_get, CacheFile_scale_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0001000000f, 1000.0f, 0.0001000000f, 1000.0f, 10.0f, 3, 1.0f, NULL
};

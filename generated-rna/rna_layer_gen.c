...
void ViewLayer_pass_cryptomatte_depth_set(PointerRNA *ptr, int value)
{
    ...
    { BLI_STATIC_ASSERT((TYPEOF_MAX(data->cryptomatte_levels) >= 16) && (TYPEOF_MIN(data->cryptomatte_levels) <= 2), "invalid limits"); }
}
...
void AOVs_remove_call(bContext *C, ReportList *reports, PointerRNA *_ptr, ParameterList *_parms)
{
	struct ViewLayer *_self;
	struct ViewLayerAOV *aov;
	char *_data;
...
bool LayerCollection_has_selected_objects_func(struct LayerCollection *_self, Main *bmain, struct ViewLayer *view_layer)
{
...
FloatPropertyRNA rna_ViewLayer_pass_alpha_threshold = {
	...
	ViewLayer_pass_alpha_threshold_get, ViewLayer_pass_alpha_threshold_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 1.0f, 0.0f, 1.0f, 10.0f, 3, 0.0f, NULL
};
...
BoolPropertyRNA rna_ViewLayer_use_sky = {
	...
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Scene_render_update, 84148224, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
...
FunctionRNA rna_AOVs_add_func = {
	{(FunctionRNA *)&rna_AOVs_remove_func, NULL,
	NULL,
...
FunctionRNA rna_AOVs_remove_func = {
	{NULL, (FunctionRNA *)&rna_AOVs_add_func,
	NULL,
...
FloatPropertyRNA rna_FreestyleSettings_sphere_radius = {
	...
	FreestyleSettings_sphere_radius_get, FreestyleSettings_sphere_radius_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 1000.0f, 0.0f, 1000.0f, 10.0f, 3, 1.0f, NULL
};
...
FloatPropertyRNA rna_FreestyleSettings_kr_derivative_epsilon = {
	...
	FreestyleSettings_kr_derivative_epsilon_get, FreestyleSettings_kr_derivative_epsilon_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, -1000.0f, 1000.0f, -1000.0f, 1000.0f, 10.0f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_FreestyleSettings_crease_angle = {
	...
	FreestyleSettings_crease_angle_get, FreestyleSettings_crease_angle_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 3.1415927410f, 0.0f, 3.1415927410f, 10.0f, 3, 0.0f, NULL
};

...
FloatPropertyRNA rna_FloatColorAttributeValue_color_srgb;
...
FloatPropertyRNA rna_ByteColorAttributeValue_color_srgb;
...
CollectionPropertyRNA rna_Int2Attribute_data;


CollectionPropertyRNA rna_Int2AttributeValue_rna_properties;
PointerPropertyRNA rna_Int2AttributeValue_rna_type;
IntPropertyRNA rna_Int2AttributeValue_value;
...
StringPropertyRNA rna_AttributeGroup_default_color_name;
StringPropertyRNA rna_AttributeGroup_active_color_name;
...
{
    return rna_pointer_inherit_refine(&iter->parent, &RNA_Int2AttributeValue, rna_iterator_array_get(iter));
}
...
void Int2Attribute_data_begin(CollectionPropertyIterator *iter, PointerRNA *ptr)
{
    ...
    memset(iter, 0, sizeof(*iter));
    iter->parent = *ptr;
    iter->prop = (PropertyRNA *)&rna_Int2Attribute_data;
...
int Int2Attribute_data_lookup_int(PointerRNA *ptr, int index, PointerRNA *r_ptr)
{
    int found = 0;
    CollectionPropertyIterator iter;

    Int2Attribute_data_begin(&iter, ptr);
    ...
    if (iter.valid) {
        ...
        if (found) { *r_ptr = Int2Attribute_data_get(&iter); }
    }

    Int2Attribute_data_end(&iter);
...
void Int2AttributeValue_rna_properties_begin(CollectionPropertyIterator *iter, PointerRNA *ptr)
{
    ...
    memset(iter, 0, sizeof(*iter));
    iter->parent = *ptr;
    iter->prop = (PropertyRNA *)&rna_Int2AttributeValue_rna_properties;
...
int Int2AttributeValue_rna_properties_lookup_string(PointerRNA *ptr, const char *key, PointerRNA *r_ptr)
{
    return rna_builtin_properties_lookup_string(ptr, key, r_ptr);
}
...
void Int2AttributeValue_value_set(PointerRNA *ptr, const int values[2])
{
    ...
    { BLI_STATIC_ASSERT((TYPEOF_MAX(data->x) >= 2147483647) && (TYPEOF_MIN(data->x) <= -2147483648), "invalid limits"); }
}
...
{
    PropIntGetFunc fn = rna_ByteIntAttributeValue_get;
    return fn(ptr);
}

void ByteIntAttributeValue_value_set(PointerRNA *ptr, int value)
{
    PropIntSetFunc fn = rna_ByteIntAttributeValue_set;
    fn(ptr, value);
}
...
{
    PropIntGetFunc fn = rna_AttributeGroup_active_index_get;
    return fn(ptr);
}

void AttributeGroup_active_index_set(PointerRNA *ptr, int value)
{
    PropIntSetFunc fn = rna_AttributeGroup_active_index_set;
    fn(ptr, value);
}
...
{
    PropIntGetFunc fn = rna_AttributeGroup_active_color_index_get;
    return fn(ptr);
}

void AttributeGroup_active_color_index_set(PointerRNA *ptr, int value)
{
    PropIntSetFunc fn = rna_AttributeGroup_active_color_index_set;
    fn(ptr, value);
}

int AttributeGroup_render_color_index_get(PointerRNA *ptr)
{
    PropIntGetFunc fn = rna_AttributeGroup_render_color_index_get;
    return fn(ptr);
}

void AttributeGroup_render_color_index_set(PointerRNA *ptr, int value)
{
    PropIntSetFunc fn = rna_AttributeGroup_render_color_index_set;
    fn(ptr, value);
}

void AttributeGroup_default_color_name_get(PointerRNA *ptr, char *value)
{
    rna_AttributeGroup_default_color_name_get(ptr, value);
}

int AttributeGroup_default_color_name_length(PointerRNA *ptr)
{
    return rna_AttributeGroup_default_color_name_length(ptr);
}

void AttributeGroup_default_color_name_set(PointerRNA *ptr, const char *value)
{
    rna_AttributeGroup_default_color_name_set(ptr, value);
}

void AttributeGroup_active_color_name_get(PointerRNA *ptr, char *value)
{
    rna_AttributeGroup_active_color_name_get(ptr, value);
}

int AttributeGroup_active_color_name_length(PointerRNA *ptr)
{
    return rna_AttributeGroup_active_color_name_length(ptr);
}

void AttributeGroup_active_color_name_set(PointerRNA *ptr, const char *value)
{
    rna_AttributeGroup_active_color_name_set(ptr, value);
}
...
StringPropertyRNA rna_Attribute_name = {
	...
	0, -1, NULL},
	Attribute_name_get, Attribute_name_length, Attribute_name_set, NULL, NULL, NULL, NULL, 0, 68, ""
};
...
EnumPropertyRNA rna_Attribute_data_type = {
	...
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	Attribute_data_type_get, NULL, NULL, NULL, NULL, rna_enum_attribute_type_items, 10, 10
};
...
FloatPropertyRNA rna_FloatAttributeValue_value = {
	...
	FloatAttributeValue_value_get, FloatAttributeValue_value_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, -10000.0f, 10000.0f, -FLT_MAX, FLT_MAX, 10.0f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_FloatVectorAttributeValue_vector = {
	...
	NULL, NULL, FloatVectorAttributeValue_vector_get, FloatVectorAttributeValue_vector_set, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, -10000.0f, 10000.0f, -FLT_MAX, FLT_MAX, 10.0f, 3, 0.0f, rna_FloatVectorAttributeValue_vector_default
};
...
FloatPropertyRNA rna_FloatColorAttributeValue_color = {
	{(PropertyRNA *)&rna_FloatColorAttributeValue_color_srgb, (PropertyRNA *)&rna_FloatColorAttributeValue_rna_type,
	...
	NULL, NULL, FloatColorAttributeValue_color_get, FloatColorAttributeValue_color_set, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 1.0f, 0.0f, FLT_MAX, 10.0f, 3, 0.0f, rna_FloatColorAttributeValue_color_default
};
...
FloatPropertyRNA rna_FloatColorAttributeValue_color_srgb = {
	{NULL, (PropertyRNA *)&rna_FloatColorAttributeValue_color,
	-1, "color_srgb", 3, 0, 0, 0, 0, "Color",
	"RGBA color in sRGB color space",
	0, "*",
	PROP_FLOAT, PROP_COLOR | PROP_UNIT_NONE, NULL, 1, {4, 0, 0}, 4,
	rna_Attribute_update_data, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	NULL, NULL, FloatColorAttributeValue_color_srgb_get, FloatColorAttributeValue_color_srgb_set, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 1.0f, 0.0f, FLT_MAX, 10.0f, 3, 0.0f, rna_FloatColorAttributeValue_color_srgb_default
};

StructRNA RNA_FloatColorAttributeValue = {
	{(ContainerRNA *)&RNA_ByteColorAttribute, (ContainerRNA *)&RNA_FloatColorAttribute,
	NULL,
	{(PropertyRNA *)&rna_FloatColorAttributeValue_rna_properties, (PropertyRNA *)&rna_FloatColorAttributeValue_color_srgb}},
...
FloatPropertyRNA rna_ByteColorAttributeValue_color = {
	{(PropertyRNA *)&rna_ByteColorAttributeValue_color_srgb, (PropertyRNA *)&rna_ByteColorAttributeValue_rna_type,
	...
	rna_Attribute_update_data, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	NULL, NULL, ByteColorAttributeValue_color_get, ByteColorAttributeValue_color_set, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 1.0f, 0.0f, 1.0f, 10.0f, 3, 0.0f, rna_ByteColorAttributeValue_color_default
};
...
FloatPropertyRNA rna_ByteColorAttributeValue_color_srgb = {
	{NULL, (PropertyRNA *)&rna_ByteColorAttributeValue_color,
	-1, "color_srgb", 3, 0, 0, 0, 0, "Color",
	"RGBA color in sRGB color space",
	0, "*",
	PROP_FLOAT, PROP_COLOR | PROP_UNIT_NONE, NULL, 1, {4, 0, 0}, 4,
	rna_Attribute_update_data, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	NULL, NULL, ByteColorAttributeValue_color_srgb_get, ByteColorAttributeValue_color_srgb_set, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, 0.0f, 1.0f, 0.0f, 1.0f, 10.0f, 3, 0.0f, rna_ByteColorAttributeValue_color_srgb_default
};

StructRNA RNA_ByteColorAttributeValue = {
	{(ContainerRNA *)&RNA_IntAttribute, (ContainerRNA *)&RNA_ByteColorAttribute,
	NULL,
	{(PropertyRNA *)&rna_ByteColorAttributeValue_rna_properties, (PropertyRNA *)&rna_ByteColorAttributeValue_color_srgb}},
...
StructRNA RNA_IntAttributeValue = {
	{(ContainerRNA *)&RNA_Int2Attribute, (ContainerRNA *)&RNA_IntAttribute,
	NULL,
...
CollectionPropertyRNA rna_Int2Attribute_data = {
	...
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	Int2Attribute_data_begin, Int2Attribute_data_next, Int2Attribute_data_end, Int2Attribute_data_get, Int2Attribute_data_length, Int2Attribute_data_lookup_int, NULL, NULL, &RNA_Int2AttributeValue
};

StructRNA RNA_Int2Attribute = {
	{(ContainerRNA *)&RNA_Int2AttributeValue, (ContainerRNA *)&RNA_IntAttributeValue,
	NULL,
	{(PropertyRNA *)&rna_Int2Attribute_data, (PropertyRNA *)&rna_Int2Attribute_data}},
	"Int2Attribute", NULL, NULL, 516, NULL, "2D Integer Vector Attribute",
...
CollectionPropertyRNA rna_Int2AttributeValue_rna_properties = {
	{(PropertyRNA *)&rna_Int2AttributeValue_rna_type, NULL,
	-1, "rna_properties", 0, 0, 0, 1, 0, "Properties",
	"RNA property collection",
	0, "*",
	PROP_COLLECTION, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	Int2AttributeValue_rna_properties_begin, Int2AttributeValue_rna_properties_next, Int2AttributeValue_rna_properties_end, Int2AttributeValue_rna_properties_get, NULL, NULL, Int2AttributeValue_rna_properties_lookup_string, NULL, &RNA_Property
};

PointerPropertyRNA rna_Int2AttributeValue_rna_type = {
	{(PropertyRNA *)&rna_Int2AttributeValue_value, (PropertyRNA *)&rna_Int2AttributeValue_rna_properties,
	-1, "rna_type", 8912896, 0, 0, 0, 0, "RNA",
	"RNA type definition",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	Int2AttributeValue_rna_type_get, NULL, NULL, NULL,&RNA_Struct
};
...
IntPropertyRNA rna_Int2AttributeValue_value = {
	{NULL, (PropertyRNA *)&rna_Int2AttributeValue_rna_type,
	-1, "value", 3, 0, 0, 4, 0, "Vector",
	"2D vector",
	0, "*",
	PROP_INT, PROP_NONE | PROP_UNIT_NONE, NULL, 1, {2, 0, 0}, 2,
	rna_Attribute_update_data, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	offsetof(vec2i, x), 0, NULL},
	NULL, NULL, Int2AttributeValue_value_get, Int2AttributeValue_value_set, NULL, NULL, NULL, NULL, NULL, NULL,
	0, -10000, 10000, INT_MIN, INT_MAX, 1, 0, rna_Int2AttributeValue_value_default
};

StructRNA RNA_Int2AttributeValue = {
	{(ContainerRNA *)&RNA_StringAttribute, (ContainerRNA *)&RNA_Int2Attribute,
	NULL,
	{(PropertyRNA *)&rna_Int2AttributeValue_rna_properties, (PropertyRNA *)&rna_Int2AttributeValue_value}},
	"Int2AttributeValue", NULL, NULL, 516, NULL, "2D Integer Vector Attribute Value",
	"2D value in geometry attribute",
	"*", 17,
	NULL, (PropertyRNA *)&rna_Int2AttributeValue_rna_properties,
	NULL,
	NULL,
	NULL,
	NULL,
...
StructRNA RNA_StringAttribute = {
	{(ContainerRNA *)&RNA_StringAttributeValue, (ContainerRNA *)&RNA_Int2AttributeValue,
	NULL,
...
FloatPropertyRNA rna_Float2AttributeValue_vector = {
	...
	NULL, NULL, Float2AttributeValue_vector_get, Float2AttributeValue_vector_set, NULL, NULL, NULL, NULL, NULL, NULL, PROP_SCALE_LINEAR, -10000.0f, 10000.0f, -FLT_MAX, FLT_MAX, 10.0f, 3, 0.0f, rna_Float2AttributeValue_vector_default
};
...
IntPropertyRNA rna_AttributeGroup_render_color_index = {
	{(PropertyRNA *)&rna_AttributeGroup_default_color_name, (PropertyRNA *)&rna_AttributeGroup_active_color_index,
...
StringPropertyRNA rna_AttributeGroup_default_color_name = {
	{(PropertyRNA *)&rna_AttributeGroup_active_color_name, (PropertyRNA *)&rna_AttributeGroup_render_color_index,
	-1, "default_color_name", 262145, 0, 0, 0, 0, "Default Color Attribute",
	"The name of the default color attribute used as a fallback for rendering",
	0, "*",
	PROP_STRING, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	AttributeGroup_default_color_name_get, AttributeGroup_default_color_name_length, AttributeGroup_default_color_name_set, NULL, NULL, NULL, NULL, 0, 64, ""
};

StringPropertyRNA rna_AttributeGroup_active_color_name = {
	{NULL, (PropertyRNA *)&rna_AttributeGroup_default_color_name,
	-1, "active_color_name", 262145, 0, 0, 0, 0, "Active Color Attribute",
	"The name of the active color attribute for display and editing",
	0, "*",
	PROP_STRING, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	AttributeGroup_active_color_name_get, AttributeGroup_active_color_name_length, AttributeGroup_active_color_name_set, NULL, NULL, NULL, NULL, 0, 64, ""
};
...
EnumPropertyRNA rna_AttributeGroup_new_type = {
	...
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	NULL, NULL, NULL, NULL, NULL, rna_enum_attribute_type_items, 10, 10
};
...
StructRNA RNA_AttributeGroup = {
	...
	NULL,
	{(PropertyRNA *)&rna_AttributeGroup_rna_properties, (PropertyRNA *)&rna_AttributeGroup_active_color_name}},
